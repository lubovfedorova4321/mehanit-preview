(function(){
  function render(){
    ...
    if(oldHeader){oldHeader.outerHTML='<header class="site-header"><div class="site-nav"><a class="site-logo" href="index.html"><img src="mehanit-logo-cropped.png" alt="Механит"></a><nav class="site-menu" aria-label="Главное меню"><div class="site-menu-item"><a href="equipment.html">Каталог</a><div class="site-dropdown"><a href="equipment-turning.html">Токарные станки</a><a href="equipment-milling.html">Фрезерные станки</a><a href="equipment-grinding.html">Шлифовальные станки</a><a href="equipment-edm.html">Электроэрозионные станки</a><a href="equipment-boring.html">Горизонтально-расточные станки</a><a href="equipment-drilling.html">Сверлильные станки</a><a href="equipment-waterjet.html">Гидроабразивные станки</a><a href="equipment-laser.html">Листообработка</a></div></div><a href="stock.html">В наличии</a><div class="site-menu-item"><a href="solutions.html">Решения</a><div class="site-dropdown"><a href="solution-auto.html">Автомобильная промышленность</a><a href="solution-aero.html">Авиационная промышленность</a><a href="solution-ship.html">Судостроение</a><a href="solution-rail.html">Железнодорожное машиностроение</a><a href="solution-agro.html">Сельхоз и дорожно-строительное</a><a href="solution-instr.html">Приборостроение</a><a href="solution-fuel.html">Топливно-энергетический сектор</a><a href="solution-mining.html">Горнорудная промышленность</a><a href="solution-space.html">Космическая промышленность</a></div></div><div class="site-menu-item"><a href="production-equipment.html">Инструмент и оснастка</a><div class="site-dropdown"><a href="production-cutting-tools.html">Режущий инструмент</a><a href="production-tooling.html">Оснастка</a><a href="production-measurement.html">Измерение</a><a href="production-automation.html">Автоматизация</a><a href="production-coolant-chips.html">СОЖ и стружка</a><a href="production-complex.html">Комплексное оснащение</a><a href="production-calculators.html">Калькуляторы режимов</a><a href="spravochnik.html">Справочник технолога</a></div></div><a href="service.html">Сервис</a><a href="press.html">Пресс-центр</a><div class="site-menu-item"><a href="about.html">О компании</a><div class="site-dropdown"><a href="process.html">Как мы работаем</a><a href="leasing.html">Лизинг</a><a href="faq.html">Частые вопросы</a><a href="contacts.html">Контакты</a></div></div><div class="site-menu-mobile-extra"><button class="site-menu-mobile-action" id="mobileSearchBtn" type="button">Поиск по сайту</button><button class="site-menu-mobile-action site-menu-mobile-cta" id="mobileCallbackBtn" type="button">Заказать звонок</button><a class="site-menu-mobile-action" href="tel:88005511206">8 800 55 11 206</a><a class="site-menu-mobile-action" href="mailto:info@mehanit.ru">info@mehanit.ru</a><div class="site-menu-mobile-messengers"><a aria-label="Telegram" href="https://t.me/mehanit" rel="noopener" target="_blank"><svg viewBox="0 0 24 24"><path d="M21.7 3.4 18.5 20c-.2 1-.8 1.2-1.6.8l-4.5-3.3-2.2 2.1c-.2.2-.4.4-.9.4l.3-4.6 8.4-7.6c.4-.3-.1-.5-.5-.2L7.2 14.1 2.8 12.7c-1-.3-1-1 0-1.4L20.5 2.6c.8-.3 1.5.2 1.2.8Z"/></svg>Telegram</a><a aria-label="MAX" href="https://max.ru/id5256089670_biz" rel="noopener" target="_blank">MAX</a></div></div></nav><div class="site-actions"><button class="site-search-btn" id="headerSearchBtn" type="button" aria-label="Открыть поиск"><svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="6.5"></circle><path d="m16 16 4.5 4.5"></path></svg></button><button type="button" class="site-cta site-cta-task" id="headerTaskBtn" title="Обсудить задачу с технологом">Обсудить задачу</button><button class="site-cta site-cta-callback" id="headerCallbackBtn" type="button">Заказать звонок</button><a class="site-contacts-link" href="contacts.html">Контакты</a><button class="site-phone" id="headerPhoneBtn" type="button" aria-expanded="false" aria-controls="headerContactsPanel"><span>8 800 55 11 206</span><svg class="site-phone-chevron" aria-hidden="true" viewBox="0 0 24 24"><path d="m7 10 5 5 5-5"></path></svg></button><button class="site-burger" type="button" aria-label="Открыть меню">☰</button></div></div></header>'}
  ...
  function initMobileMenuAccordion(){
    ...
    if(!header)return;
    var mq=window.matchMedia('(max-width:1339px)');
    var items=Array.prototype.slice.call(header.querySelectorAll('.site-menu-item')).filter(function(item){
      return item.querySelector(':scope > .site-dropdown')&&item.querySelector(':scope > a');
    });
    ...
    items.forEach(function(item,idx){
      var link=item.querySelector(':scope > a');
      var dropdown=item.querySelector(':scope > .site-dropdown');
      item.classList.add('has-dropdown');
      if(!dropdown.id)dropdown.id='siteDropdown'+idx;
    ...
    var burger=header.querySelector('.site-burger');
    if(burger){
      burger.addEventListener('click',function(){
        if(!header.classList.contains('menu-open'))closeItems();
      });
    }
    window.addEventListener('resize',function(){
      if(!mq.matches)closeItems();
    },{passive:true});
  }
  if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',initMobileMenuAccordion)}else{initMobileMenuAccordion()}
  ...
  var HEADER_SEARCH_ITEMS=[
    ...
    {title:'Ленточнопильные станки',category:'Оборудование',url:'equipment-laser.html',text:'Отрезное оборудование под серийные задачи.'},
    ...
    {title:'Листообработка',category:'Оборудование',url:'equipment-laser.html',text:'Лазерная резка, гильотины, листогибы, ленточные пилы.'},
    {title:'Гидроабразивные станки',category:'Оборудование',url:'equipment-waterjet.html',text:'Гидроабразивная резка металла, камня и композитов.'},
    ...
    {title:'Пресс-центр',category:'Раздел',url:'press.html',text:'Инженерные материалы о металлообработке и производстве.'},
    {title:'Как выбрать вертикальный обрабатывающий центр',category:'Пресс-центр',url:'press-kak-vybrat-vertikalnyy-obrabatyvayushchiy-centr.html',text:'Практический алгоритм выбора VMC от детали: X/Y/Z, стол, шпиндель, магазин, точность и автоматизация.'},
    {title:'Справочник технолога',category:'Справочник',url:'spravochnik.html',text:'Формулы, обозначения и справочные таблицы для подбора инструмента и режимов.'},
    {title:'Формулы резания',category:'Справочник',url:'spravochnik-formuly-rezaniya.html',text:'Основные расчётные формулы режимов резания с обозначениями и единицами: обороты, скорость, подача, съём, мощность, время'},
    {title:'Маркировка пластин',category:'Справочник',url:'spravochnik-markirovka-plastin.html',text:'Как читать обозначение сменной пластины по ISO 1832: форма, задний угол, класс допуска, тип крепления, размер, толщина, '},
    {title:'Износ инструмента',category:'Справочник',url:'spravochnik-iznos-instrumenta.html',text:'Виды износа инструмента: по задней поверхности, лунка, выкрашивание, скол, пластическая деформация, нарост, термические '},
    {title:'Шероховатость',category:'Справочник',url:'spravochnik-sherohovatost.html',text:'Параметры шероховатости Ra и Rz, соотношение между ними, старые классы чистоты и достижимая шероховатость по видам обраб'},
    {title:'Твёрдость материалов',category:'Справочник',url:'spravochnik-tverdost.html',text:'Таблица приблизительного перевода твёрдости между шкалами Роквелла, Бринелля и Виккерса, и как твёрдость заготовки влияе'},
    {title:'Резьбы',category:'Справочник',url:'spravochnik-rezby.html',text:'Основные типы резьб — метрическая, дюймовая, трубная, трапецеидальная, упорная — их обозначения, профили и диаметры отве'},
    {title:'Калькуляторы режимов и стоимости',category:'Оснащение',url:'production-calculators.html',text:'Обороты, подача, мощность, время цикла и стоимость обработки детали.'},
    {title:'Точение на станках с ЧПУ',category:'Оснащение',url:'instrument-tochenie.html',text:'Инструмент, стартовые режимы и типовые проблемы операции.'},
    {title:'Фрезерование на станках с ЧПУ',category:'Оснащение',url:'instrument-frezerovanie.html',text:'Инструмент, стартовые режимы и типовые проблемы операции.'},
    {title:'Сверление на станках с ЧПУ',category:'Оснащение',url:'instrument-sverlenie.html',text:'Инструмент, стартовые режимы и типовые проблемы операции.'},
    {title:'Резьбообработка на станках с ЧПУ',category:'Оснащение',url:'instrument-rezba.html',text:'Инструмент, стартовые режимы и типовые проблемы операции.'},
    {title:'Растачивание на станках с ЧПУ',category:'Оснащение',url:'instrument-rastachivanie.html',text:'Инструмент, стартовые режимы и типовые проблемы операции.'},
    {title:'Обработка: Конструкционные и легированные стали',category:'Оснащение',url:'obrabotka-stali.html',text:'Что усложняет обработку, режимы по операциям, что выбирать.'},
    {title:'Обработка: Нержавеющие и жаропрочные аустенитные стали',category:'Оснащение',url:'obrabotka-nerzhaveyushchey-stali.html',text:'Что усложняет обработку, режимы по операциям, что выбирать.'},
    {title:'Обработка: Серый и высокопрочный чугун',category:'Оснащение',url:'obrabotka-chuguna.html',text:'Что усложняет обработку, режимы по операциям, что выбирать.'},
    {title:'Обработка: Алюминиевые и медные сплавы',category:'Оснащение',url:'obrabotka-alyuminiya.html',text:'Что усложняет обработку, режимы по операциям, что выбирать.'},
    {title:'Обработка: Титановые и никелевые жаропрочные сплавы',category:'Оснащение',url:'obrabotka-titana.html',text:'Что усложняет обработку, режимы по операциям, что выбирать.'},
    {title:'Обработка: Закалённые стали 45–62 HRC',category:'Оснащение',url:'obrabotka-zakalennoy-stali.html',text:'Что усложняет обработку, режимы по операциям, что выбирать.'},
    {title:'MACRO TOOLS',category:'Бренды инструмента',url:'brand-macro-tools.html',text:'Инструментальная программа Механит: подбор, поставка и внедрение.'},
    {title:'Derek',category:'Бренды инструмента',url:'brand-derek.html',text:'Инструментальная оснастка, расточные системы, токарный и фрезерный инструмент.'},
    {title:'Palbit',category:'Бренды инструмента',url:'brand-palbit.html',text:'Твердосплавные пластины, токарный, фрезерный и сверлильный инструмент.'},
    {title:'Vargus',category:'Бренды инструмента',url:'brand-vargus.html',text:'Резьбообработка, канавки и отрезка, миниатюрная обработка.'},
    {title:'Likon',category:'Бренды инструмента',url:'brand-likon.html',text:'Инструмент, оснастка и промышленное оборудование, инжиниринг.'},
    {title:'Vergnano',category:'Бренды инструмента',url:'brand-vergnano.html',text:'Резьбообразующий, зуборезный и протяжной инструмент.'},
    {title:'Nanoloy',category:'Бренды инструмента',url:'brand-nanoloy.html',text:'Твердосплавные пластины и фрезы для нержавеющих, жаропрочных и закалённых материалов.'},
    {title:'Telcon',category:'Бренды инструмента',url:'brand-telcon.html',text:'Алмазный инструмент PCD, CVD и PCBN для композитов и цветных металлов.'},
    {title:'OMAP',category:'Бренды инструмента',url:'brand-omap.html',text:'Приводной инструмент, угловые головки и оснастка для токарных станков с ЧПУ.'},
    {title:'ILIX',category:'Бренды инструмента',url:'brand-ilix.html',text:'Прецизионный инструмент для обработки отверстий и резьбы.'},
    {title:'Fresal',category:'Бренды инструмента',url:'brand-fresal.html',text:'Монолитные фрезы, свёрла и развёртки, в том числе для алюминия и аэрокосмоса.'},
    {title:'Helion',category:'Бренды инструмента',url:'brand-helion.html',text:'Фрезы, свёрла, развёртки и резьбовой инструмент.'},
    {title:'Sauter',category:'Бренды инструмента',url:'brand-sauter.html',text:'Револьверные головки, приводные и стационарные блоки VDI и BMT.'},
    {title:'AMI-Han’ei',category:'Бренды инструмента',url:'brand-ami-hanei.html',text:'Высокоточные цанги и направляющие втулки для токарных автоматов.'},
    {title:'Brice',category:'Бренды инструмента',url:'brand-brice.html',text:'Твердосплавный инструмент и технологическая оснастка российского производства.'},
    {title:'Ann Way',category:'Бренды инструмента',url:'brand-annway.html',text:'Инструментальная оснастка: патроны, хвостовики, расточные системы.'},
    {title:'Gabriel Mauvais',category:'Бренды инструмента',url:'brand-gabriel-mauvais.html',text:'Микросвёрла и микрошлифованные детали для микромеханики.'},
    {title:'Инструмент и оснастка',category:'Оснащение',url:'production-equipment.html',text:'Инструмент, оснастка, измерение, автоматизация, СОЖ.'},
    ...
    {title:'BL-1236A F',category:'Токарные станки',url:'equipment-turning-bl-1236a-f.html',text:'Токарно-винторезный станок BL-1236A (усиленное исполнение): над станиной 300 мм, РМЦ 610/914 мм, отверстие шпинделя 38 мм, 75–1400 об/мин, привод 1,1 кВт.'},
    {title:'1440K F',category:'Токарные станки',url:'equipment-turning-1440k-f.html',text:'Токарно-винторезный станок 1440K: над станиной 356 мм, РМЦ 1000/1500 мм, отверстие шпинделя 40 мм, 12 ступеней 40–1800 об/мин, привод 2,4 кВт.'},
    {title:'CW61140E H',category:'Токарные станки',url:'equipment-turning-cw61140e-h.html',text:'Тяжёлый токарно-винторезный станок CW61140E/CW61160E: диаметр над станиной 1500–1700 мм, РМЦ до 10000 мм, привод 55 кВт, грузоподъёмность 25 т, направляющие 1100 мм.'},
    {title:'Q1343 H',category:'Токарные станки',url:'equipment-turning-q1343-h.html',text:'Токарно-винторезный трубонарезной станок Q1343: диаметр над станиной 1000 мм, отверстие шпинделя 440 мм, патрон Φ1000 мм, главный привод 22 кВт, РМЦ до 3000 мм.'},
    {title:'CW6163B H',category:'Токарные станки',url:'equipment-turning-cw6163b-h.html',text:'Универсальный токарно-винторезный станок серии CW6163B: диаметр над станиной 630–1000 мм, скорость шпинделя 6–1000 об/мин, РМЦ до 3 м, привод 11–15 кВт.'},
    {title:'TU2506 F',category:'Токарные станки',url:'equipment-turning-tu2506-f.html',text:'Мини-токарный станок TU2506/TU2506 Vario: над станиной 250 мм, РМЦ 550 мм, отверстие шпинделя 26 мм, 125–2000 / 30–4000 об/мин, привод 550/850 Вт.'},
    {title:'LZC F',category:'Токарные станки',url:'equipment-turning-lzc-f.html',text:'Тяжёлый токарно-винторезный станок LZC F: диаметр над станиной до Ø1200 мм, РМЦ до 10000 мм, отверстие шпинделя Ø105 мм, привод 11 кВт, гэп с проёмом 300 мм.'},
    {title:'VL5225D F',category:'Токарные станки',url:'equipment-turning-vl5225d-f.html',text:'Двухстоечный вертикальный токарный станок с ЧПУ VL5225D F: диаметр точения до Ø2500 мм, стол Ø2250 мм, масса заготовки до 16 т, крутящий момент 63 кН·м, 55 кВт.'},
    {title:'TU2406 F',category:'Токарные станки',url:'equipment-turning-tu2406-f.html',text:'Мини-токарный станок TU2406/TU2406 Vario: над станиной 250 мм, РМЦ 550 мм, отверстие шпинделя 26 мм, 125–2000 / 30–4000 об/мин, привод 550/850 Вт.'},
    {title:'BQ1022 F',category:'Токарные станки',url:'equipment-turning-bq1022-f.html',text:'Настольный токарно-винторезный станок BQ1022/BQ1126: над станиной 254/280 мм, отверстие шпинделя 26 мм, 125–2000 об/мин, привод 0,75 кВт.'},
    {title:'L26 F',category:'Токарные станки',url:'equipment-turning-l26-f.html',text:'Прецизионный токарно-винторезный станок L26 F: высота центров под Ø660 мм, отверстие шпинделя Ø105 мм, 36–1600 об/мин, РМЦ до 3000 мм, привод 7,5/11 кВт.'},
    {title:'CW61100B H',category:'Токарные станки',url:'equipment-turning-cw61100b-h.html',text:'Токарно-винторезный станок CW61100B: высота центров над станиной φ1000 мм, отверстие шпинделя φ130 мм, привод 22 кВт, патрон φ1000. Купить в России.'},
    {title:'CW61140H H',category:'Токарные станки',url:'equipment-turning-cw61140h-h.html',text:'Токарно-винторезный станок CW61140H (серия CWH1): высота центров под φ1500 мм, РМЦ 3000–10000 мм, отверстие шпинделя φ130 мм, грузоподъёмность 20 т. Купить в России.'},
    {title:'L1440ZX F',category:'Токарные станки',url:'equipment-turning-l1440zx-f.html',text:'Прецизионный токарный станок серии L…ZX: над станиной 360–500 мм, РМЦ 1000–3000 мм, отверстие шпинделя 80 мм, 40–1800 об/мин, привод 5,5/7,5 кВт.'},
    {title:'LE-A-B-C F',category:'Токарные станки',url:'equipment-turning-le-a-b-c-f.html',text:'Токарный станок серии LE-A/B/C: над станиной 400–800 мм, длина заготовки до 4000 мм, отверстие шпинделя 52/80/105 мм, 10–1400 об/мин, привод 7,5 кВт.'},
    {title:'1640G F',category:'Токарные станки',url:'equipment-turning-1640g-f.html',text:'Токарно-винторезный станок 1640G: РМЦ 1000 мм, диаметр над станиной 400 мм, отверстие шпинделя 52 мм, 12 ступеней 44–2000 об/мин, привод 2,4 кВт.'},
    {title:'TU2907 F',category:'Токарные станки',url:'equipment-turning-tu2907-f.html',text:'Токарные станки серии TU2907–TU3109 Vario: над станиной 290–310 мм, РМЦ 700–900 мм, отверстие шпинделя 26/38 мм, 30–3000 об/мин, привод до 2,2 кВт.'},
    {title:'CW61125L H',category:'Токарные станки',url:'equipment-turning-cw61125l-h.html',text:'Тяжёлый токарно-винторезный станок CW61125L/CW61140L/CW61160L: диаметр над станиной 1300–1700 мм, РМЦ до 10000 мм, привод 30 кВт, патрон до Φ1400 мм.'},
    {title:'BL-1440D F',category:'Токарные станки',url:'equipment-turning-bl-1440d-f.html',text:'Прецизионный токарно-винторезный станок BL-1440D: над станиной 360 мм, РМЦ 750/1000 мм, шпиндель 70–2000 об/мин, привод 1,5 кВт, широкий набор резьб.'},
    {title:'TU2807 F',category:'Токарные станки',url:'equipment-turning-tu2807-f.html',text:'Мини-токарный станок TU2807/TU2807 Vario: над станиной 280/290 мм, РМЦ 700 мм, отверстие шпинделя 26 мм, 150–2000 об/мин, привод 850/1100 Вт.'},
    {title:'CW61180L H',category:'Токарные станки',url:'equipment-turning-cw61180l-h.html',text:'Тяжёлый токарно-винторезный станок CW61180L/CW61200L: диаметр над станиной 1900–2100 мм, РМЦ до 10000 мм, привод 37 кВт, патрон Φ1600 мм, удлинённая станина.'},
    {title:'CW61180H H',category:'Токарные станки',url:'equipment-turning-cw61180h-h.html',text:'Токарно-винторезный станок CW61180H (серия CWH1): высота центров под φ1900 мм, РМЦ 3000–10000 мм, отверстие шпинделя φ130 мм, грузоподъёмность 20 т. Купить в России.'},
    {title:'TU1803 Vario F',category:'Токарные станки',url:'equipment-turning-tu1803-vario-f.html',text:'Мини-токарный станок TU1803/TU2104 Vario: над станиной 180/210 мм, РМЦ 300/400 мм, отверстие шпинделя 21 мм, 150–2500 об/мин, привод 600 Вт.'},
    {title:'LB-LC-LD F',category:'Токарные станки',url:'equipment-turning-lb-lc-ld-f.html',text:'Токарный станок серии LB/LC/LD: над станиной 16"–24" (≈400–610 мм), отверстие шпинделя 65/80 мм, РМЦ 750–2000 мм. Универсальный станок.'},
    {title:'LH F',category:'Токарные станки',url:'equipment-turning-lh-f.html',text:'Тяжёлый токарно-винторезный станок LH F: диаметр над станиной до Ø2080 мм, РМЦ до 12000 мм, отверстие шпинделя 130 мм, главный привод 30 кВт, станина 1100 мм.'},
    {title:'VL5126S F',category:'Токарные станки',url:'equipment-turning-vl5126s-f.html',text:'Одностоечный вертикальный токарный станок VL5126S F: диаметр точения до Ø2600 мм, планшайба Ø2300 мм, масса заготовки до 10 т, главный привод 37 кВт.'},
    {title:'BL-1440A F',category:'Токарные станки',url:'equipment-turning-bl-1440a-f.html',text:'Токарно-винторезный станок BL-1440A/BL-1440B: РМЦ 1000 мм, над станиной 360 мм, отверстие шпинделя 38/52 мм, 70–2000 об/мин, привод 1,5 кВт.'},
    {title:'CR62 F',category:'Токарные станки',url:'equipment-turning-cr62-f.html',text:'Прецизионный токарный станок CR62: над станиной 410–660 мм, РМЦ 1000–3000 мм, отверстие шпинделя 58/80 мм, 25–2000 об/мин, привод 5,5/7,5 кВт.'},
    {title:'LF16 F',category:'Токарные станки',url:'equipment-turning-lf16-f.html',text:'Лоботокарный станок LF16 F: диаметр над станиной до Ø1600 мм, высота центров 800 мм, патрон до Ø1600 мм, масса заготовки до 3000 кг, главный привод 11 кВт.'},
    {title:'Q1313C H',category:'Токарные станки',url:'equipment-turning-q1313c-h.html',text:'Токарно-винторезный трубонарезной станок серии Q1313C: диаметр над станиной 630–800 мм, отверстие шпинделя 130–280 мм, скорость 6–800 об/мин, РМЦ до 3000 мм.'},
    {title:'TU0618 F',category:'Токарные станки',url:'equipment-turning-tu0618-f.html',text:'Мини-токарный станок TU0618/TU0618A: над станиной 180 мм, РМЦ до 350 мм, отверстие шпинделя 20 мм, бесступ. 50–2500 об/мин, привод 400/550 Вт.'},
    {title:'BL-1236 F',category:'Токарные станки',url:'equipment-turning-bl-1236-f.html',text:'Токарно-винторезный станок BL-1236: над станиной 300 мм, РМЦ 610/914 мм, отверстие шпинделя 38 мм, 9 ступеней 75–1400 об/мин, привод 1,1 кВт.'},
    {title:'1440G F',category:'Токарные станки',url:'equipment-turning-1440g-f.html',text:'Токарно-винторезный станок 1440G: над станиной 356 мм, РМЦ 1000 мм, отверстие шпинделя 38 мм, 16 ступеней 45–1800 об/мин, привод до 2,2 кВт.'},
    {title:'1640GH F',category:'Токарные станки',url:'equipment-turning-1640gh-f.html',text:'Прецизионный токарный станок 1640GH/1660GH: над станиной 410 мм, РМЦ 1000/1500 мм, отверстие шпинделя 52 мм, 16 ступеней 45–1800 об/мин, привод до 4,5 кВт.'},
    {title:'LS F',category:'Токарные станки',url:'equipment-turning-ls-f.html',text:'Серия токарно-винторезных станков LS F с выемкой станины: диаметр над станиной Ø500–800 мм, отверстие шпинделя Ø82/105 мм, до 1600 об/мин, привод 7,5 кВт.'},
    {title:'LW F',category:'Токарные станки',url:'equipment-turning-lw-f.html',text:'Тяжёлый токарно-винторезный станок LW F: диаметр над станиной до Ø1200 мм, РМЦ до 11850 мм, отверстие шпинделя Ø105/130 мм, 7,5–1000 об/мин, привод 11/15 кВт.'},
    {title:'Q1327 H',category:'Токарные станки',url:'equipment-turning-q1327-h.html',text:'Токарно-винторезный трубонарезной станок серии Q13 (Q1327–Q1350): диаметр над станиной 1000–1200 мм, отверстие шпинделя 280–520 мм, привод 22 кВт, патрон до Φ1000 мм.'},
    {title:'L16-22 F',category:'Токарные станки',url:'equipment-turning-l16-22-f.html',text:'Прецизионный токарный станок серии L16-22: над станиной 410–560 мм, РМЦ 1000–3000 мм, отверстие шпинделя 58/80 мм, 25–2000 об/мин, привод 5,5/7,5 кВт.'},
    {title:'KDCK-40 K',category:'Токарные станки',url:'equipment-turning-kdck-40-k.html',text:'Токарный станок с ЧПУ KDCK-40: диаметр над станиной Ø750 мм, отверстие шпинделя Ø105 мм, шпиндель до 2000 об/мин, 12-позиц. револьвер, патрон 12".'},
    {title:'STL8-550 Z',category:'Токарные станки',url:'equipment-turning-stl8-550-z.html',text:'STL8-550 — токарный станок с ЧПУ и наклонной станиной 35°: патрон 8", шпиндель 4000 об/мин, проход прутка Ø52 мм, длина 550 мм, привод 15/11 кВт.'},
    {title:'STL18-1000 Z',category:'Токарные станки',url:'equipment-turning-stl18-1000-z.html',text:'Токарный станок с ЧПУ STL18-1000 с наклонной станиной 45°: патрон 15–18", свес Ø800 мм, длина 1000 мм, мощность до 40 кВт, задняя бабка.'},
    {title:'CK7660L B',category:'Токарные станки',url:'equipment-turning-ck7660l-b.html',text:'Токарный станок с ЧПУ CK7660L с наклонной станиной: свес до Ø830 мм, шпиндель 22–2500 об/мин, мощность до 45 кВт, 12 позиций револьвера.'},
    {title:'STL8-750 Z',category:'Токарные станки',url:'equipment-turning-stl8-750-z.html',text:'STL8-750 — токарный станок с ЧПУ и наклонной станиной 35°: патрон 8", шпиндель 4000 об/мин, проход прутка Ø52 мм, длина 750 мм, привод 15/11 кВт.'},
    {title:'KDCK-25 K',category:'Токарные станки',url:'equipment-turning-kdck-25-k.html',text:'Токарный станок с ЧПУ KDCK-25: диаметр над станиной Ø500 мм, шпиндель до 4200 об/мин, привод 11/15 кВт, 8-позиц. револьвер, патрон 8 дюймов.'},
    {title:'KDCL-15D K',category:'Токарные станки',url:'equipment-turning-kdcl-15d-k.html',text:'Двухшпиндельный токарный станок с ЧПУ KDCL-15D с наклонной станиной 45°: диаметр над станиной Ø600 мм, шпиндель 4000 об/мин, привод 11/15 кВт.'},
    {title:'KDCL-32 K',category:'Токарные станки',url:'equipment-turning-kdcl-32-k.html',text:'Токарный станок с ЧПУ KDCL-32: диаметр над станиной Ø700 мм, отверстие шпинделя Ø80/Ø86 мм, привод 30/37 кВт, ускоренная подача 30 м/мин, патрон 10".'},
    {title:'STL18-1500 Z',category:'Токарные станки',url:'equipment-turning-stl18-1500-z.html',text:'Токарный станок с ЧПУ STL18-1500 с наклонной станиной 45°: патрон 15–18", свес Ø800 мм, длина 1500 мм, мощность до 40 кВт, задняя бабка.'},
    {title:'SL8 Z',category:'Токарные станки',url:'equipment-turning-sl8-z.html',text:'Токарный станок с ЧПУ SL8 с наклонной станиной 45°: патрон 8", свес Ø450 мм, шпиндель до 4000 об/мин, линейные направляющие, револьвер 8/12.'},
    {title:'STL8-1100 Z',category:'Токарные станки',url:'equipment-turning-stl8-1100-z.html',text:'STL8-1100 — токарный станок с ЧПУ и наклонной станиной 35°: патрон 8", шпиндель 4000 об/мин, проход прутка Ø52 мм, длина 1100 мм, привод 11/15 кВт.'},
    {title:'KDCL-28 K',category:'Токарные станки',url:'equipment-turning-kdcl-28-k.html',text:'Токарный станок с ЧПУ KDCL-28 с наклонной станиной: диаметр над станиной Ø520 мм, шпиндель до 5000 об/мин, 12-позиц. револьвер, привод 11/15 кВт.'},
    {title:'SL6 Z',category:'Токарные станки',url:'equipment-turning-sl6-z.html',text:'Токарный станок с ЧПУ SL6 с наклонной станиной: патрон 6–10", свес Ø480 мм, шпиндель до 5000 об/мин, линейные направляющие, револьвер 8/12.'},
    {title:'CBK50 B',category:'Токарные станки',url:'equipment-turning-cbk50-b.html',text:'Токарный станок с ЧПУ CBK50 с наклонной станиной: свес Ø500 мм, длина точения 1000 мм, шпиндель 21–1620 об/мин, момент 800 Н·м, 7,5 кВт.'},
    {title:'SL12 Z',category:'Токарные станки',url:'equipment-turning-sl12-z.html',text:'Токарный станок с ЧПУ SL12 с наклонной станиной: патрон 12–15", свес Ø550 мм, шпиндель до 1800 об/мин, линейные направляющие, револьвер 8/12.'},
    {title:'CK7525 B',category:'Токарные станки',url:'equipment-turning-ck7525-b.html',text:'Токарный станок с ЧПУ CK7525 с наклонной станиной 45°: диаметр над станиной Ø550 мм, отверстие шпинделя Ø87 мм, привод 15/18.5 кВт, патрон Ø254 мм.'},
    {title:'STL24-1000 Z',category:'Токарные станки',url:'equipment-turning-stl24-1000-z.html',text:'STL24-1000 — тяжёлый токарный станок с ЧПУ и наклонной станиной 45°: патрон 24", проход прутка Ø117 мм, длина 1000 мм, привод 40/30 кВт, линейные направляющие.'},
    {title:'STH12-750B Z',category:'Токарные станки',url:'equipment-turning-sth12-750b-z.html',text:'Токарный станок с ЧПУ STH12-750B с наклонной станиной 45°: диаметр Ø320 мм, длина 750 мм, шпиндель до 3000 об/мин, коробчатые направляющие.'},
    {title:'KDCL-35 K',category:'Токарные станки',url:'equipment-turning-kdcl-35-k.html',text:'Токарный станок с ЧПУ KDCL-35 с наклонной станиной: диаметр над станиной Ø750 мм, отверстие шпинделя Ø105 мм, привод 37/45 кВт, длина до 3000 мм.'},
    {title:'KDCL-16P K',category:'Токарные станки',url:'equipment-turning-kdcl-16p-k.html',text:'Токарный станок с ЧПУ KDCL-16P с наклонной станиной 45°: диаметр над станиной Ø320 мм, шпиндель до 5000 об/мин, отверстие Ø52 мм, привод 3.7 кВт.'},
    {title:'STL6-SX Z',category:'Токарные станки',url:'equipment-turning-stl6-sx-z.html',text:'STL6-SX — двухшпиндельный токарный станок с ЧПУ и наклонной станиной: главный и контршпиндель 5000 об/мин, пруток Ø46 мм, привод 15/11 кВт, обработка с двух сторон.'},
    {title:'STL10-1600 Z',category:'Токарные станки',url:'equipment-turning-stl10-1600-z.html',text:'STL10-1600 — токарный станок с ЧПУ и наклонной станиной 35°: патрон 10", шпиндель 3000 об/мин, проход прутка Ø75 мм, длина 1600 мм, привод 18.5/15 кВт.'},
    {title:'STL12-1600 Z',category:'Токарные станки',url:'equipment-turning-stl12-1600-z.html',text:'STL12-1600 — токарный станок с ЧПУ и наклонной станиной 35°: патрон 12", проход прутка Ø91 мм, длина заготовки 1600 мм, привод 15/18.5 кВт, линейные направляющие.'},
    {title:'STL12 Z',category:'Токарные станки',url:'equipment-turning-stl12-z.html',text:'STL12 — токарный станок с ЧПУ и наклонной станиной 35°: патрон 12"/15", проход прутка Ø91 мм, шпиндель 1800 об/мин, привод 15/11 кВт, линейные направляющие.'},
    {title:'STH10-750B Z',category:'Токарные станки',url:'equipment-turning-sth10-750b-z.html',text:'Токарный станок с ЧПУ STH10-750B с наклонной станиной 45°: диаметр Ø320 мм, длина 750 мм, шпиндель до 3200 об/мин, коробчатые направляющие.'},
    {title:'STL15-2000 Z',category:'Токарные станки',url:'equipment-turning-stl15-2000-z.html',text:'Токарный станок с ЧПУ STL15-2000 с наклонной станиной 45°: патрон 12–15", свес Ø650 мм, длина до 2000 мм, шпиндель 1800 об/мин, задняя бабка.'},
    {title:'STL12-3000 Z',category:'Токарные станки',url:'equipment-turning-stl12-3000-z.html',text:'STL12-3000 — токарный станок с ЧПУ и наклонной станиной 35°: патрон 12", проход прутка до Ø91 мм, длина заготовки 3000 мм, привод 15/18.5 кВт, 12 позиций.'},
    {title:'STH10-500B Z',category:'Токарные станки',url:'equipment-turning-sth10-500b-z.html',text:'Токарный станок с ЧПУ STH10-500B с наклонной станиной 45°: диаметр Ø320 мм, длина 500 мм, шпиндель до 3200 об/мин, коробчатые направляющие.'},
    {title:'STL18-750 Z',category:'Токарные станки',url:'equipment-turning-stl18-750-z.html',text:'Токарный станок с ЧПУ STL18-750 с наклонной станиной 45°: патрон 15–18", свес Ø800 мм, длина 750 мм, мощность до 40 кВт, задняя бабка.'},
    {title:'STL6 Z',category:'Токарные станки',url:'equipment-turning-stl6-z.html',text:'STL6 — компактный токарный станок с ЧПУ и наклонной станиной 45°: патрон 6", шпиндель 4500 об/мин, проход прутка Ø46 мм, привод 11/7.5 кВт, линейные направляющие.'},
    {title:'STL10-2000 Z',category:'Токарные станки',url:'equipment-turning-stl10-2000-z.html',text:'STL10-2000 — токарный станок с ЧПУ и наклонной станиной 35°: патрон 10", шпиндель 3000 об/мин, проход прутка Ø75 мм, длина в центрах 2000 мм, привод 18.5/15 кВт.'},
    {title:'KDCL-30 K',category:'Токарные станки',url:'equipment-turning-kdcl-30-k.html',text:'Токарный станок с ЧПУ KDCL-30 с наклонной станиной: диаметр над станиной Ø650 мм, отверстие шпинделя Ø90 мм, привод 30/37 кВт, 12-позиц. револьвер.'},
    {title:'CBK63 B',category:'Токарные станки',url:'equipment-turning-cbk63-b.html',text:'Токарный станок с ЧПУ CBK63 с наклонной станиной 45°: диаметр над станиной Ø630 мм, отверстие шпинделя Ø84 мм, привод 11 кВт, ход Z до 3000 мм.'},
    {title:'STL8 Z',category:'Токарные станки',url:'equipment-turning-stl8-z.html',text:'STL8 — токарный станок с ЧПУ и наклонной станиной 35°: патрон 8"/10", шпиндель 4000 об/мин, проход прутка Ø52 мм, привод 11/7.5 кВт, линейные направляющие.'},
    {title:'CK7516 B',category:'Токарные станки',url:'equipment-turning-ck7516-b.html',text:'Токарный станок с ЧПУ CK7516 с наклонной станиной 45°: диаметр над станиной Ø400 мм, шпиндель до 5500 об/мин, привод 11/15 кВт, 12-позиц. револьвер.'},
    {title:'CK40 B',category:'Токарные станки',url:'equipment-turning-ck40-b.html',text:'Токарный станок с ЧПУ CK40 с наклонной станиной 45°: диаметр над станиной Ø400 мм, шпиндель до 3000 об/мин, привод 7.5 кВт, система FANUC 0i Mate.'},
    {title:'KDCL-50B K',category:'Токарные станки',url:'equipment-turning-kdcl-50b-k.html',text:'Тяжёлый токарный станок с ЧПУ KDCL-50B: диаметр над станиной Ø1000 мм, отверстие шпинделя Ø160 мм, привод 22 кВт, ход Z 2100 мм, масса 13 т.'},
    {title:'KDCL-15 K',category:'Токарные станки',url:'equipment-turning-kdcl-15-k.html',text:'Токарный станок с ЧПУ KDCL-15 с наклонной станиной 45°: диаметр над станиной Ø360 мм, шпиндель до 6000 об/мин, привод 7.5/11 кВт, 8-позиц. револьвер.'},
    {title:'STL12-750-1000 Z',category:'Токарные станки',url:'equipment-turning-stl12-750-1000-z.html',text:'STL12-750/1000 — токарный станок с ЧПУ и наклонной станиной 35°: патрон 12", шпиндель 3000 об/мин, проход прутка Ø75 мм, длина заготовки 750/1000 мм, привод 11/15 кВт.'},
    {title:'KDCL-35B K',category:'Токарные станки',url:'equipment-turning-kdcl-35b-k.html',text:'Токарный станок с ЧПУ KDCL-35B с наклонной станиной 45°: диаметр над станиной Ø700 мм, отверстие шпинделя Ø105 мм, привод 22 кВт, ход Z 1550 мм.'},
    {title:'CK50 B',category:'Токарные станки',url:'equipment-turning-ck50-b.html',text:'Токарный станок с ЧПУ CK50 с наклонной станиной 45°: диаметр над станиной Ø500 мм, шпиндель до 2250 об/мин, привод 15 кВт, патрон Ø210 мм, FANUC 0i.'},
    {title:'SL10 Z',category:'Токарные станки',url:'equipment-turning-sl10-z.html',text:'Токарный станок с ЧПУ SL10 с наклонной станиной 35°: патрон 10", свес Ø550 мм, шпиндель до 3200 об/мин, линейные направляющие, револьвер 8/12.'},
    {title:'STH12-500B Z',category:'Токарные станки',url:'equipment-turning-sth12-500b-z.html',text:'Токарный станок с ЧПУ STH12-500B с наклонной станиной 45°: диаметр Ø320 мм, длина 500 мм, шпиндель до 3000 об/мин, коробчатые направляющие.'},
    {title:'KDCL-30B K',category:'Токарные станки',url:'equipment-turning-kdcl-30b-k.html',text:'Токарный станок с ЧПУ KDCL-30B: диаметр над станиной Ø700 мм, отверстие шпинделя Ø80/Ø86 мм, привод 30/37 кВт, 12-позиц. револьвер, патрон 10".'},
    {title:'STL15-1500 Z',category:'Токарные станки',url:'equipment-turning-stl15-1500-z.html',text:'Токарный станок с ЧПУ STL15-1500 с наклонной станиной 45°: патрон 12–15", свес Ø650 мм, длина до 1500 мм, шпиндель 1800 об/мин, задняя бабка.'},
    {title:'STL12-2000 Z',category:'Токарные станки',url:'equipment-turning-stl12-2000-z.html',text:'STL12-2000 — токарный станок с ЧПУ и наклонной станиной 35°: патрон 12", проход прутка Ø91 мм, длина в центрах 2000 мм, привод 15/18.5 кВт, линейные направляющие.'},
    {title:'BC37 B',category:'Токарные станки',url:'equipment-turning-bc37-b.html',text:'Токарный станок с ЧПУ BC37 с наклонной станиной: свес Ø550 мм, шпиндель 50–4500 об/мин, мощность 11/15 кВт, револьвер 8/12, ЧПУ GSK988TA.'},
    {title:'STL5 Z',category:'Токарные станки',url:'equipment-turning-stl5-z.html',text:'STL5 — компактный токарный станок с ЧПУ и наклонной станиной 45°: патрон 5", шпиндель 4500 об/мин, проход прутка Ø40 мм, привод 5.5/7.5 кВт, линейные направляющие.'},
    {title:'KDCL-16 K',category:'Токарные станки',url:'equipment-turning-kdcl-16-k.html',text:'Токарный станок с ЧПУ KDCL-16: диаметр над станиной Ø470 мм, шпиндель до 6000 об/мин, ускоренная подача 30 м/мин, 12-позиц. револьвер, патрон 6".'},
    {title:'CK7530 B',category:'Токарные станки',url:'equipment-turning-ck7530-b.html',text:'Токарный станок с ЧПУ CK7530 с наклонной станиной 60°: диаметр над станиной Ø670 мм, отверстие шпинделя Ø105 мм, привод 22/30 кВт, патрон Ø305 мм.'},
    {title:'SL10E Z',category:'Токарные станки',url:'equipment-turning-sl10e-z.html',text:'Токарный станок с ЧПУ SL10E с наклонной станиной 60°: патрон 8–10", свес Ø500 мм, шпиндель до 4000 об/мин, линейные направляющие, револьвер 8/12.'},
    {title:'STL18-3000 Z',category:'Токарные станки',url:'equipment-turning-stl18-3000-z.html',text:'Токарный станок с ЧПУ STL18-3000 с наклонной станиной 45°: патрон 15–18", свес Ø800 мм, длина 3100 мм, мощность до 40 кВт, задняя бабка.'},
    {title:'STL18-2000 Z',category:'Токарные станки',url:'equipment-turning-stl18-2000-z.html',text:'Токарный станок с ЧПУ STL18-2000 с наклонной станиной 45°: патрон 15–18", свес Ø800 мм, длина 2000 мм, мощность до 40 кВт, задняя бабка.'},
    {title:'CK7520 B',category:'Токарные станки',url:'equipment-turning-ck7520-b.html',text:'Токарный станок с ЧПУ CK7520 с наклонной станиной 45°: диаметр над станиной Ø500 мм, отверстие шпинделя Ø62 мм, привод 11/15 кВт, патрон Ø210 мм.'},
    {title:'STL8-S Z',category:'Токарные станки',url:'equipment-turning-stl8-s-z.html',text:'Двухшпиндельный токарный станок с ЧПУ STL8-S: главный шпиндель 8" 4000 об/мин, контршпиндель 6" 5000 об/мин, револьвер BMT55, 12 позиций.'},
    {title:'STL10 Z',category:'Токарные станки',url:'equipment-turning-stl10-z.html',text:'STL10 — токарный станок с ЧПУ и наклонной станиной 35°: патрон 10", шпиндель 3000 об/мин, проход прутка Ø75 мм, привод 15/18.5 кВт, линейные направляющие.'},
    {title:'DT300E Z',category:'Токарные станки',url:'equipment-turning-dt300e-z.html',text:'DT300E — компактный токарный центр с приводным инструментом и осью Y серии Star DT: точение Ø160 мм, длина 250 мм, 15/11 кВт, 5000 об/мин, револьвер BMT40.'},
    {title:'TN500S-1500 Z',category:'Токарные станки',url:'equipment-turning-tn500s-1500-z.html',text:'TN500S-1500 — двухшпиндельный токарно-фрезерный центр с приводным инструментом: точение Ø320 мм, длина 1500 мм, 27/18,5 кВт, 4000 об/мин, BMT55.'},
    {title:'TS600 Z',category:'Токарные станки',url:'equipment-turning-ts600-z.html',text:'Токарный обрабатывающий центр TS600 Z: патрон 10", проходное отверстие Ø75 мм, шпиндель 3000 об/мин, 12-позиционная приводная револьверная головка.'},
    {title:'DT350E Z',category:'Токарные станки',url:'equipment-turning-dt350e-z.html',text:'DT350E — токарный центр с приводным инструментом и осью Y серии Star DT: точение Ø160 мм, длина 320 мм, 15/11 кВт, 5000 об/мин, револьвер BMT40.'},
    {title:'TS400 Z',category:'Токарные станки',url:'equipment-turning-ts400-z.html',text:'Токарный обрабатывающий центр TS400 Z: патрон 6", шпиндель 5000 об/мин 15/11 кВт, проходное отверстие Ø46 мм, 12-позиционная приводная головка.'},
    {title:'TS500 Z',category:'Токарные станки',url:'equipment-turning-ts500-z.html',text:'Токарный обрабатывающий центр TS500 Z: патрон 8", встроенный шпиндель 4000 об/мин 27/18.5 кВт, 12-позиционная приводная головка, наклон станины 60°.'},
    {title:'DT500ES-1500 Z',category:'Токарные станки',url:'equipment-turning-dt500es-1500-z.html',text:'DT500ES-1500 — двухшпиндельный токарно-фрезерный центр с приводным инструментом: точение Ø320 мм, длина 1500 мм, ось Y, 27/18,5 кВт, BMT55.'},
    {title:'TN500-S Z',category:'Токарные станки',url:'equipment-turning-tn500-s-z.html',text:'TN500-S — токарно-фрезерный центр с контршпинделем: точение Ø320 мм, длина 650 мм, шпиндель 27/18,5 кВт, 4000 об/мин, револьвер BMT55 на 12 позиций.'},
    {title:'TN800 Z',category:'Токарные станки',url:'equipment-turning-tn800-z.html',text:'Токарный обрабатывающий центр TN800 Z: патрон 18", проходное отверстие Ø95 мм, шпиндель 1500 об/мин, задняя бабка MT5, 12-позиционная приводная головка.'},
    {title:'TN500-650 Z',category:'Токарные станки',url:'equipment-turning-tn500-650-z.html',text:'Токарный обрабатывающий центр TN500-650 Z: патрон 8", длина 650 мм, встроенный шпиндель 4000 об/мин, задняя бабка MT5, 12-позиционная приводная головка.'},
    {title:'DT500E Z',category:'Токарные станки',url:'equipment-turning-dt500e-z.html',text:'DT500E — токарный центр с приводным инструментом и осью Y серии Star DT: точение Ø320 мм, длина 650 мм, 27/18,5 кВт, 4000 об/мин, револьвер BMT45.'},
    {title:'TN500-450 Z',category:'Токарные станки',url:'equipment-turning-tn500-450-z.html',text:'Токарный обрабатывающий центр TN500-450 Z: патрон 8", длина 450 мм, встроенный шпиндель 4000 об/мин, гидравлическая задняя бабка, 12-позиционная головка.'},
    {title:'DT450E Z',category:'Токарные станки',url:'equipment-turning-dt450e-z.html',text:'DT450E — токарный центр с приводным инструментом и осью Y серии Star DT: точение Ø210 мм, длина 450 мм, 27/18,5 кВт, 4000 об/мин, револьвер BMT45.'},
    {title:'DT400E Z',category:'Токарные станки',url:'equipment-turning-dt400e-z.html',text:'DT400E — токарный центр с приводным инструментом и осью Y серии Star DT: точение Ø160 мм, длина 320 мм, 15/11 кВт, 5000 об/мин, револьвер BMT40.'},
    {title:'CH7516GS B',category:'Токарные станки',url:'equipment-turning-ch7516gs-b.html',text:'CH7516GS — высокоскоростной токарный центр с приводным инструментом: шпиндель 80–8000 об/мин, 15/18,7 кВт, револьвер на 12 позиций, точение диаметром до 250 мм.'},
    {title:'TN400-SX Z',category:'Токарные станки',url:'equipment-turning-tn400-sx-z.html',text:'TN400-SX — двухшпиндельный токарный центр с приводным инструментом: точение Ø160 мм, длина 400 мм, 15/11 кВт, 5000 об/мин, синхронная обработка с двух сторон.'},
    {title:'TC500 Z',category:'Токарные станки',url:'equipment-turning-tc500-z.html',text:'TC500 — двухшпиндельный токарный центр с приводным инструментом и осью Y под 45°: точение Ø320 мм, шпиндель 27/18,5 кВт, 4000 об/мин, револьвер BMT55.'},
    {title:'TN600-3000 Z',category:'Токарные станки',url:'equipment-turning-tn600-3000-z.html',text:'Токарный обрабатывающий центр TN600-3000 Z: патрон 10/12", длина 3000 мм, шпиндель до 3000 об/мин, задняя бабка MT5, 12-позиционная приводная головка.'},
    {title:'TN700 Z',category:'Токарные станки',url:'equipment-turning-tn700-z.html',text:'Токарный обрабатывающий центр TN700 Z: патрон 15", длина заготовки 1250 мм, шпиндель 2000 об/мин, задняя бабка MT5, 12-позиционная приводная головка.'},
    {title:'TN600 Z',category:'Токарные станки',url:'equipment-turning-tn600-z.html',text:'Токарный обрабатывающий центр TN600 Z: патрон 10", проходное отверстие Ø75 мм, шпиндель 3000 об/мин, задняя бабка MT5, 12-позиционная приводная головка.'},
    {title:'TN500 Z',category:'Токарные станки',url:'equipment-turning-tn500-z.html',text:'Токарный обрабатывающий центр TN500 Z: патрон 8", длина 500 мм, встроенный шпиндель 4000 об/мин, задняя бабка MT4, 12-позиционная приводная головка.'},
    {title:'TC500MYT-650 Z',category:'Токарные станки',url:'equipment-turning-tc500myt-650-z.html',text:'TC500MYT-650 — токарный центр с приводным инструментом и осью Y под 45°: точение Ø320 мм, длина 650 мм, 27/18,5 кВт, 4000 об/мин, BMT55, гидробабка.'},
    {title:'DT500E-1000 Z',category:'Токарные станки',url:'equipment-turning-dt500e-1000-z.html',text:'DT500E-1000 — токарный центр с приводным инструментом и осью Y серии Star DT: точение Ø320 мм, длина 1000 мм, 27/18,5 кВт, 4000 об/мин, BMT55.'},
    {title:'MTK20 B',category:'Токарные станки',url:'equipment-turning-mtk20-b.html',text:'MTK20 — двухшпиндельный токарно-фрезерный центр с приводным инструментом: 2 револьвера 16×2, ось Y, шпиндель 18,5/22 кВт, 5000 об/мин.'},
    {title:'TN500-1000 Z',category:'Токарные станки',url:'equipment-turning-tn500-1000-z.html',text:'Токарный обрабатывающий центр TN500-1000 Z: патрон 8/10", длина 1000 мм, встроенный шпиндель 4000 об/мин, 12-позиционная приводная револьверная головка.'},
    {title:'BL20-HSY B',category:'Токарные станки',url:'equipment-turning-bl20-hsy-b.html',text:'BL20-HSY — токарно-фрезерный центр с приводным инструментом: два шпинделя, ось Y ±50 мм, 17,2 кВт, 4500 об/мин, револьвер BMT55 на 12 позиций.'},
    {title:'DT500E-450 Z',category:'Токарные станки',url:'equipment-turning-dt500e-450-z.html',text:'DT500E-450 — токарный центр с приводным инструментом и осью Y серии Star DT: точение Ø320 мм, длина 450 мм, 27/18,5 кВт, 4000 об/мин, BMT45.'},
    {title:'DT500ES-900 Z',category:'Токарные станки',url:'equipment-turning-dt500es-900-z.html',text:'DT500ES-900 — двухшпиндельный токарно-фрезерный центр с приводным инструментом: точение Ø320 мм, длина 900 мм, ось Y, шпиндель 27/18,5 кВт, BMT55.'},
    {title:'DT500E-S Z',category:'Токарные станки',url:'equipment-turning-dt500e-s-z.html',text:'DT500E-S — токарный центр с приводным инструментом и контршпинделем: точение Ø320 мм, ось Y ±70 мм, шпиндель 27/18,5 кВт, 4000 об/мин, револьвер BMT55.'},
    {title:'DT500E-1500 Z',category:'Токарные станки',url:'equipment-turning-dt500e-1500-z.html',text:'DT500E-1500 — токарный центр с приводным инструментом и осью Y серии Star DT: точение Ø320 мм, длина 1500 мм, 27/18,5 кВт, 4000 об/мин, BMT55.'},
    {title:'TN500S-900 Z',category:'Токарные станки',url:'equipment-turning-tn500s-900-z.html',text:'TN500S-900 — двухшпиндельный токарно-фрезерный центр с приводным инструментом: точение Ø320 мм, длина 900 мм, 27/18,5 кВт, 4000 об/мин, BMT55.'},
    {title:'TN500-1600 Z',category:'Токарные станки',url:'equipment-turning-tn500-1600-z.html',text:'Токарный обрабатывающий центр TN500-1600 Z: патрон 8/10", длина 1600 мм, встроенный шпиндель 4000 об/мин, задняя бабка MT5, 12-позиционная приводная головка.'},
    {title:'BHR1000V B',category:'Токарные станки',url:'equipment-turning-bhr1000v-b.html',text:'Токарно-фрезерный обрабатывающий центр BHR1000V: планшайба Ø1020 мм, фрезерный шпиндель 3200 об/мин, ось B/C, ЧПУ Siemens ONE / китайская ЧПУ. Точение, фрезерование, сверление с одной установки.'},
    {title:'BHR700V B',category:'Токарные станки',url:'equipment-turning-bhr700v-b.html',text:'Токарно-фрезерный обрабатывающий центр BHR700V: планшайба Ø700 мм, фрезерный шпиндель 12000 об/мин, ось B/C, ЧПУ Siemens 828D/ONE. Точение, фрезерование, сверление с одной установки.'},
    {title:'BHR800V B',category:'Токарные станки',url:'equipment-turning-bhr800v-b.html',text:'Токарно-фрезерный обрабатывающий центр BHR800V: планшайба Ø820 мм, фрезерный шпиндель 5000 об/мин, ось B/C, ЧПУ Siemens ONE / китайская ЧПУ. Точение, фрезерование, сверление с одной установки.'},
    {title:'TBX63S Z',category:'Токарные станки',url:'equipment-turning-tbx63s-z.html',text:'TBX63S Z — токарно-фрезерный центр с контршпинделем, B-осью ±120°, фрезошпинделем HSK63 12000 об/мин, магазином на 24/30 инструментов и прутком 65 мм.'},
    {title:'BHR1500V B',category:'Токарные станки',url:'equipment-turning-bhr1500v-b.html',text:'Токарно-фрезерный обрабатывающий центр BHR1500V: планшайба Ø1520 мм, фрезерный шпиндель 3200 об/мин, ось B/C, ЧПУ Siemens ONE / китайская ЧПУ. Точение, фрезерование, сверление с одной установки.'},
    {title:'BHR500V B',category:'Токарные станки',url:'equipment-turning-bhr500v-b.html',text:'Токарно-фрезерный обрабатывающий центр BHR500V: планшайба Ø600 мм, фрезерный шпиндель 12000 об/мин, ось B/C, ЧПУ Siemens 828D/ONE. Точение, фрезерование, сверление с одной установки.'},
    {title:'BHR1200V B',category:'Токарные станки',url:'equipment-turning-bhr1200v-b.html',text:'Токарно-фрезерный обрабатывающий центр BHR1200V: планшайба Ø1220 мм, фрезерный шпиндель 3200 об/мин, ось B/C, ЧПУ Siemens ONE / китайская ЧПУ. Точение, фрезерование, сверление с одной установки.'},
    {title:'BHR300V B',category:'Токарные станки',url:'equipment-turning-bhr300v-b.html',text:'Токарно-фрезерный обрабатывающий центр BHR300V: планшайба Ø400 мм, фрезерный шпиндель 12000 об/мин, ось B/C, ЧПУ Siemens 828D/ONE. Точение, фрезерование, сверление с одной установки.'},
    {title:'FTH6150 Z',category:'Токарные станки',url:'equipment-turning-fth6150-z.html',text:'Токарный станок с ЧПУ FTH6150 с горизонтальной станиной: патрон 12", диаметр над станиной 500 мм, шпиндель до 2500 об/мин, мощность до 15 кВт.'},
    {title:'QKD1325 H',category:'Токарные станки',url:'equipment-turning-qkd1325-h.html',text:'Трубонарезной токарный станок с ЧПУ QKD1325 (755 мм): отверстие шпинделя 240 мм, нарезка труб 50–235 мм, двигатель 22 кВт, точность резьбы 0,01 мм.'},
    {title:'SL350 Z',category:'Токарные станки',url:'equipment-turning-sl350-z.html',text:'Станок SL350 Flash с ЧПУ: диаметр над станиной Ø420 мм, шпиндель до 5000 об/мин, привод до 7,5 кВт, ход X/Z 350/300 мм, наклон станины 35°.'},
    {title:'SH30B Z',category:'Токарные станки',url:'equipment-turning-sh30b-z.html',text:'Компактный токарный обрабатывающий центр SH30B с ЧПУ: патрон 30 мм, шпиндель 3000 об/мин, мощность 3 кВт, наклонная станина 45°, гребёнчатый суппорт.'},
    {title:'CK6150 K',category:'Токарные станки',url:'equipment-turning-ck6150-k.html',text:'Токарный станок с ЧПУ CK6150 с горизонтальной станиной: диаметр обработки диска до 500 мм, отверстие шпинделя 82 мм, до 1600 об/мин, мощность 7,5 кВт.'},
    {title:'STH15 Z',category:'Токарные станки',url:'equipment-turning-sth15-z.html',text:'Токарный станок с ЧПУ STH15 серии Hunter: патрон 15", диаметр над станиной 700 мм, отверстие шпинделя 120 мм, наклон станины 30°, мощность до 18,5 кВт.'},
    {title:'FL630 Z',category:'Токарные станки',url:'equipment-turning-fl630-z.html',text:'Токарный центр FL630 Z: диаметр над станиной Ø650 мм, отверстие шпинделя Ø120 мм, патрон 15", мощность до 18,5 кВт, линейные направляющие.'},
    {title:'CK61100 F',category:'Токарные станки',url:'equipment-turning-ck61100-f.html',text:'Тяжёлый токарный станок с ЧПУ CK61100 (серия 755): диаметр над станиной 1000–1600 мм, отверстие шпинделя 130 мм, двигатель 22 кВт, патрон Ø1000 мм.'},
    {title:'SH40B Z',category:'Токарные станки',url:'equipment-turning-sh40b-z.html',text:'Токарный центр SH40B Z: диаметр над станиной Ø300 мм, цанга Ø40 мм, шпиндель 3000 об/мин, мощность 4 кВт, наклонная станина 45°, масса 1600 кг.'},
    {title:'CK61100 H',category:'Токарные станки',url:'equipment-turning-ck61100-h.html',text:'Тяжёлый токарный станок с ЧПУ CK61100: диаметр над станиной 1000–1600 мм, отверстие шпинделя 130 мм, двигатель 22/30/37 кВт, патрон Ø1000 мм.'},
    {title:'SL450 Z',category:'Токарные станки',url:'equipment-turning-sl450-z.html',text:'Станок SL450 Flash с ЧПУ: диаметр над станиной Ø400 мм, шпиндель до 4500 об/мин, привод 7,5 кВт, ход X/Z 450/410 мм, линейные направляющие.'},
    {title:'CK61125E H',category:'Токарные станки',url:'equipment-turning-ck61125e-h.html',text:'Сверхтяжёлый токарный станок с ЧПУ CK61125E (1100 мм): диаметр над станиной 1300–2100 мм, отверстие шпинделя 100 мм, двигатель 55 кВт, патрон до Ø1600 мм.'},
    {title:'CK61160A H',category:'Токарные станки',url:'equipment-turning-ck61160a-h.html',text:'Тяжёлые станки CK61160A-CK61250A: диаметр над станиной 1600-2500 мм, длина заготовки до 20000 мм, привод 65 кВт, грузоподъёмность 25 т.'},
    {title:'CK6180 H',category:'Токарные станки',url:'equipment-turning-ck6180-h.html',text:'Токарный станок с ЧПУ CK6180/CKQ61100: диаметр над станиной 800/1000 мм, отверстие шпинделя 104 мм, двигатель 15 кВт, патрон Ø400 мм.'},
    {title:'CK6163 H',category:'Токарные станки',url:'equipment-turning-ck6163-h.html',text:'Токарный станок с ЧПУ CK6163/CKQ6180: диаметр над станиной 630/800 мм, отверстие шпинделя 104 мм, двигатель 11 кВт, патрон Ø315 мм.'},
    {title:'FTL660-3000 Z',category:'Токарные станки',url:'equipment-turning-ftl660-3000-z.html',text:'Токарный обрабатывающий центр FTL660-3000 Z с ЧПУ: диаметр над станиной Ø700 мм, длина до 3000 мм, шпиндель 15 кВт, отверстие Ø120 мм, линейные направляющие.'},
    {title:'FTH6140 Z',category:'Токарные станки',url:'equipment-turning-fth6140-z.html',text:'Токарный станок с ЧПУ FTH6140 с горизонтальной станиной: диаметр над станиной 530 мм, шпиндель до 4000 об/мин, мощность до 15 кВт, задняя бабка.'},
    {title:'SL340 Z',category:'Токарные станки',url:'equipment-turning-sl340-z.html',text:'Станок SL340 Flash с ЧПУ: диаметр над станиной Ø300 мм, шпиндель до 5000 об/мин, привод до 7,5 кВт, ход X/Z 340/200 мм, наклон станины 35°.'},
    {title:'CK6156E F',category:'Токарные станки',url:'equipment-turning-ck6156e-f.html',text:'Токарный станок с ЧПУ CK6156E/CK6166E: макс. диаметр диска Ø560/660 мм, отверстие шпинделя 80/105 мм, двигатель 7,5/11 кВт, ЧПУ.'},
    {title:'STH12 Z',category:'Токарные станки',url:'equipment-turning-sth12-z.html',text:'Токарный центр STH12 Z: патрон 12"/15", диаметр над станиной Ø520 мм, шпиндель до 2500 об/мин, мощность до 15 кВт, наклонная станина 30°.'},
    {title:'FTH6136 Z',category:'Токарные станки',url:'equipment-turning-fth6136-z.html',text:'Токарный станок с ЧПУ FTH6136 с горизонтальной станиной: патрон 8", диаметр над станиной 350 мм, шпиндель до 2500 об/мин, задняя бабка, мощность до 11 кВт.'},
    {title:'FTL550 Z',category:'Токарные станки',url:'equipment-turning-ftl550-z.html',text:'Токарный обрабатывающий центр FTL550 Z: диаметр над станиной Ø550 мм, отверстие шпинделя до Ø120 мм, мощность до 18,5 кВт, длина до 3000 мм, линейные направляющие.'},
    {title:'FTL300 Z',category:'Токарные станки',url:'equipment-turning-ftl300-z.html',text:'Токарный обрабатывающий центр FTL300 Z: диаметр над станиной Ø300 мм, шпиндель до 5000 об/мин, патрон 6", линейные направляющие, масса 1900 кг.'},
    {title:'FL280 Z',category:'Токарные станки',url:'equipment-turning-fl280-z.html',text:'Токарный центр FL280 Z: диаметр над станиной Ø300 мм, шпиндель до 4500 об/мин, цанговый/патронный зажим, линейные направляющие, масса 1400 кг.'},
    {title:'CKG200 K',category:'Токарные станки',url:'equipment-turning-ckg200-k.html',text:'Токарный станок с ЧПУ CKG200 с большим отверстием шпинделя 210 мм: диаметр над станиной 900 мм, труба до 200 мм, мощность 18,5 кВт, для труб.'},
    {title:'CK6130S K',category:'Токарные станки',url:'equipment-turning-ck6130s-k.html',text:'Токарный станок с ЧПУ CK6130S с горизонтальной станиной: диаметр обработки диска до 300 мм, шпиндель до 3500 об/мин, револьвер 4/6 позиций, мощность 3 кВт.'},
    {title:'CK61140D K',category:'Токарные станки',url:'equipment-turning-ck61140d-k.html',text:'Тяжёлый токарный станок с ЧПУ CK61140D: диаметр над станиной от 1400 мм, длина до 12 м, главный двигатель 55 кВт, точность круглости 0,02 мм.'},
    {title:'CK61125L H',category:'Токарные станки',url:'equipment-turning-ck61125l-h.html',text:'Токарный станок с ЧПУ CK61125L (серия CKL, 1100 мм): диаметр над станиной 1300–2100 мм, отверстие шпинделя 100 мм, двигатель 30/37 кВт.'},
    {title:'FTH6166 Z',category:'Токарные станки',url:'equipment-turning-fth6166-z.html',text:'Токарный станок с ЧПУ FTH6166 с горизонтальной станиной: патрон 15", диаметр над станиной 700 мм, отверстие шпинделя 120 мм, мощность 18,5 кВт.'},
    {title:'CK6191L F',category:'Токарные станки',url:'equipment-turning-ck6191l-f.html',text:'Токарный станок с ЧПУ CK6191L: диаметр над станиной 910–1100 мм, отверстие шпинделя 104 мм, двигатель 15 кВт, ЧПУ FANUC 0i-TF / SINUMERIK 828D.'},
    {title:'FTL400 Z',category:'Токарные станки',url:'equipment-turning-ftl400-z.html',text:'Токарный обрабатывающий центр FTL400 Z: диаметр над станиной Ø400 мм, шпиндель до 4000 об/мин, мощность до 11 кВт, патрон 8", линейные направляющие.'},
    {title:'CK61H H',category:'Токарные станки',url:'equipment-turning-ck61h-h.html',text:'Токарный станок с ЧПУ CK61H с плоской станиной (1100 мм): диаметр над станиной 1300–2100 мм, шпиндель Ø130 мм, двигатель 37 кВт, ЧПУ Siemens.'},
    {title:'FTL500 Z',category:'Токарные станки',url:'equipment-turning-ftl500-z.html',text:'Токарный обрабатывающий центр FTL500 Z: диаметр над станиной Ø500 мм, шпиндель до 4000 об/мин, мощность до 15 кВт, длина до 2000 мм, линейные направляющие.'},
    {title:'CK61100CE K',category:'Токарные станки',url:'equipment-turning-ck61100ce-k.html',text:'Тяжёлый токарный станок с ЧПУ CK61100CE: диаметр обработки диска до 1000 мм, отверстие шпинделя 130 мм, длина до 10 м, мощность 26 кВт.'},
    {title:'STH8 Z',category:'Токарные станки',url:'equipment-turning-sth8-z.html',text:'Токарный центр STH8 Z: патрон 8", диаметр над станиной Ø350 мм, шпиндель до 4500 об/мин, мощность 5,5 кВт, наклонная станина 30°.'},
    {title:'CK61140H-1 H',category:'Токарные станки',url:'equipment-turning-ck61140h-1-h.html',text:'Токарный станок с ЧПУ CK61140H/1 (1100 мм): диаметр над станиной 1500–2100 мм, шпиндель Ø130 мм, двигатель 37 кВт, патрон до Ø1600 мм.'},
    {title:'FTL320 Z',category:'Токарные станки',url:'equipment-turning-ftl320-z.html',text:'Токарный обрабатывающий центр FTL320 Z: диаметр над станиной Ø400 мм, шпиндель до 5000 об/мин, патрон 6", линейные направляющие, ускоренная подача до 25 м/мин.'},
    {title:'CK-L F',category:'Токарные станки',url:'equipment-turning-ck-l-f.html',text:'Серия токарных станков с ЧПУ CK-L (CK6150L/6166L/6180L): диаметр над станиной 500–800 мм, шпиндель до 1600 об/мин, двигатель 7,5–11 кВт.'},
    {title:'SL580 Z',category:'Токарные станки',url:'equipment-turning-sl580-z.html',text:'Станок SL580 Flash с ЧПУ: диаметр над станиной Ø380 мм, шпиндель до 5000 об/мин, привод до 11 кВт, ход X/Z 580/320 мм, наклон станины 45°.'},
    {title:'CK6150 H',category:'Токарные станки',url:'equipment-turning-ck6150-h.html',text:'Токарный станок с ЧПУ CK6150/CK6156: диаметр над станиной 500/560 мм, отверстие шпинделя 82 мм, двигатель 7,5 кВт, патрон Ø250 мм.'},
    {title:'STH6 Z',category:'Токарные станки',url:'equipment-turning-sth6-z.html',text:'Токарный центр STH6 Z: патрон 6", диаметр над станиной Ø300 мм, шпиндель до 5000 об/мин, мощность 4 кВт, наклонная станина 30°.'},
    {title:'CK6163A K',category:'Токарные станки',url:'equipment-turning-ck6163a-k.html',text:'Токарный станок с ЧПУ CK6163A с горизонтальной станиной: диаметр обработки диска до 630 мм, отверстие шпинделя 104 мм, до 1000 об/мин, мощность 11 кВт.'},
    {title:'CK61140E K',category:'Токарные станки',url:'equipment-turning-ck61140e-k.html',text:'Тяжёлый токарный станок с ЧПУ CK61140E: диаметр обработки диска до 1400 мм, отверстие шпинделя 130 мм, длина до 10 м, мощность 26 кВт.'},
    {title:'FTL660 Z',category:'Токарные станки',url:'equipment-turning-ftl660-z.html',text:'Токарный обрабатывающий центр FTL660 Z: диаметр над станиной Ø700 мм, отверстие шпинделя Ø120 мм, мощность до 18,5 кВт, длина до 3000 мм, линейные направляющие.'},
    {title:'CK6140 F',category:'Токарные станки',url:'equipment-turning-ck6140-f.html',text:'Токарный станок с ЧПУ CK6140 с плоской закалённой станиной (HRC50): диаметр над станиной Ø400 мм, отверстие шпинделя Ø60 мм, двигатель 5,5 кВт.'},
    {title:'CK6150N K',category:'Токарные станки',url:'equipment-turning-ck6150n-k.html',text:'Токарный станок с ЧПУ CK6150N с горизонтальной станиной: диаметр обработки диска до 500 мм, отверстие шпинделя 80 мм, до 2000 об/мин, мощность 7,5 кВт.'},
    {title:'SL280 Z',category:'Токарные станки',url:'equipment-turning-sl280-z.html',text:'Станок SL280 Flash с ЧПУ: диаметр над станиной Ø300 мм, шпиндель до 5000 об/мин, привод до 7,5 кВт, ход X/Z 280/240 мм, наклон станины 35°.'},
    {title:'FTH6130 Z',category:'Токарные станки',url:'equipment-turning-fth6130-z.html',text:'Токарный станок с ЧПУ FTH6130 с горизонтальной станиной: патрон 6", диаметр над станиной 300 мм, шпиндель до 4000 об/мин, задняя бабка, мощность до 7,5 кВт.'},
    {title:'QK1343 H',category:'Токарные станки',url:'equipment-turning-qk1343-h.html',text:'Трубонарезной токарный станок с ЧПУ QK1343: отверстие шпинделя 440 мм, нарезка труб 270–430 мм, двигатель 22 кВт, ЧПУ Siemens 828D/Fanuc 0i-TF.'},
    {title:'FL550 Z',category:'Токарные станки',url:'equipment-turning-fl550-z.html',text:'Токарный центр FL550 Z: диаметр над станиной Ø550 мм, отверстие шпинделя Ø105 мм, патрон 12", мощность до 15 кВт, линейные направляющие.'},
    {title:'QK1322 H',category:'Токарные станки',url:'equipment-turning-qk1322-h.html',text:'Трубонарезной токарный станок с ЧПУ QK1322 (550 мм): отверстие шпинделя 225 мм, нарезка труб 50–220 мм, двигатель 11 кВт, патрон Ø500 мм.'},
    {title:'FL300 Z',category:'Токарные станки',url:'equipment-turning-fl300-z.html',text:'Токарный центр FL300 Z: диаметр над станиной Ø300 мм, шпиндель до 5000 об/мин, патрон 6" или цанга, линейные направляющие, масса 2000 кг.'},
    {title:'STH10 Z',category:'Токарные станки',url:'equipment-turning-sth10-z.html',text:'Токарный центр STH10 Z: патрон 10", диаметр над станиной Ø450 мм, шпиндель до 4000 об/мин, мощность до 11 кВт, наклонная станина 30°.'},
    {title:'CK6163D F',category:'Токарные станки',url:'equipment-turning-ck6163d-f.html',text:'Токарный станок с ЧПУ CK6163D/CK6180D: диаметр над станиной 630/800 мм, отверстие шпинделя 104 мм, двигатель 11 кВт, длина точения до 3850 мм.'},
    {title:'CK64160E K',category:'Токарные станки',url:'equipment-turning-ck64160e-k.html',text:'Лоботокарный станок с ЧПУ CK64160E: диаметр обработки диска до 1600 мм, отверстие шпинделя 130 мм, станина 1100 мм, мощность 26 кВт.'},
    {title:'CKY61250F H',category:'Токарные станки',url:'equipment-turning-cky61250f-h.html',text:'Тяжёлые станки CKY61250F/CKY61315F: диаметр над станиной 2500-3150 мм, привод 90-110 кВт, три направляющие, патрон Ø2500-2900 мм.'},
    {title:'FTL550-3000 Z',category:'Токарные станки',url:'equipment-turning-ftl550-3000-z.html',text:'Токарный обрабатывающий центр FTL550-3000 Z: диаметр над станиной Ø550 мм, шпиндель 3000 об/мин, мощность до 15 кВт, длина до 3000 мм, линейные направляющие.'},
    {title:'QK1313 H',category:'Токарные станки',url:'equipment-turning-qk1313-h.html',text:'Трубонарезной токарный станок с ЧПУ QK1313 (550 мм): отверстие шпинделя 130 мм, нарезка труб 30–126 мм, двигатель 11 кВт, патрон Ø400 мм.'},
    {title:'CK6191B K',category:'Токарные станки',url:'equipment-turning-ck6191b-k.html',text:'Токарный станок с ЧПУ CK6191B с горизонтальной станиной: диаметр над станиной 900 мм, отверстие шпинделя 104 мм, длина до 4000 мм, мощность 15 кВт.'},
    {title:'CK61160 H',category:'Токарные станки',url:'equipment-turning-ck61160-h.html',text:'Тяжёлый токарный станок с ЧПУ CK61160 (серия 755): диаметр над станиной до 1600 мм, отверстие шпинделя 130 мм, двигатель 22/30/37 кВт, патрон Ø1000 мм.'},
    {title:'QK1319 H',category:'Токарные станки',url:'equipment-turning-qk1319-h.html',text:'Трубонарезной токарный станок с ЧПУ QK1319 (550 мм): отверстие шпинделя 206 мм, нарезка труб 50–193 мм, двигатель 11 кВт, патрон Ø500 мм.'},
    {title:'FL500 Z',category:'Токарные станки',url:'equipment-turning-fl500-z.html',text:'Токарный центр FL500 Z: диаметр над станиной Ø500 мм, отверстие шпинделя Ø81 мм, шпиндель до 4000 об/мин, патрон 10", линейные направляющие.'},
    {title:'FL400 Z',category:'Токарные станки',url:'equipment-turning-fl400-z.html',text:'Токарный центр FL400 Z: диаметр над станиной Ø400 мм, отверстие шпинделя Ø62 мм, шпиндель до 4500 об/мин, патрон 8", линейные направляющие.'},
    {title:'CKY61160C H',category:'Токарные станки',url:'equipment-turning-cky61160c-h.html',text:'Тяжёлые станки CKY61160C-CKY61250C: диаметр над станиной 1600-2500 мм, масса детали до 50 т, привод 90 кВт, револьвер на 4 позиции.'},
    {title:'CK6140ZX K',category:'Токарные станки',url:'equipment-turning-ck6140zx-k.html',text:'Токарный станок с ЧПУ CK6140ZX с горизонтальной станиной: диаметр обработки диска до 400 мм, отверстие шпинделя 80 мм, до 2000 об/мин, мощность до 7,5 кВт.'},
    {title:'SH52B Z',category:'Токарные станки',url:'equipment-turning-sh52b-z.html',text:'Токарный центр SH52B Z: диаметр над станиной Ø300 мм, пруток до Ø52 мм, шпиндель до 5000 об/мин, мощность 5,5 кВт, наклонная станина 45°.'},
    {title:'SP28 Z',category:'Токарные станки',url:'equipment-turning-sp28-z.html',text:'Прутковый автомат Super SP28: шпиндель 5000 об/мин, 5,5/3,7 кВт, пруток до Ø29 мм, биение ≤2 мкм, наклонная станина 35°. Сверхточная обработка.'},
    {title:'P30H Z',category:'Токарные станки',url:'equipment-turning-p30h-z.html',text:'Прутковый автомат Super P30H: шпиндель 5000 об/мин, 5,5/3,7 кВт, пруток до Ø30 мм, биение ≤2 мкм, наклонная станина 35°. Сверхточная обработка.'},
    {title:'XPD35 N',category:'Токарные станки',url:'equipment-turning-xpd35-n.html',text:'Прутковый автомат XPD35 с ЧПУ SYNTEC: шпиндель 5000 об/мин, 5,5/7,5 кВт, пруток до Ø35 мм, наклонная станина, биение ≤0,002 мм. Точная обработка.'},
    {title:'PD30 N',category:'Токарные станки',url:'equipment-turning-pd30-n.html',text:'Прутковый автомат PD30 с ЧПУ FANUC: шпиндель 6000 об/мин, мощность 4,2 кВт, пруток до Ø30 мм, биение ≤0,002 мм. Точная обработка малогабаритных деталей.'},
    {title:'SD-32-32Y S',category:'Токарные станки',url:'equipment-turning-sd-32-32y-s.html',text:'Прутковый автомат SD-32/32Y: шпиндель 50-6000 об/мин, 3,7 кВт, отверстие Ø32 мм, точность 0,005 мм, револьвер 8 позиций. Версия 32Y с осью Y.'},
    {title:'SC-32-42T S',category:'Токарные станки',url:'equipment-turning-sc-32-42t-s.html',text:'Прутковый автомат SC-32/42T: шпиндель до 3500 об/мин, 5,5 кВт, пруток до Ø32/42 мм, наклонная станина 20°, револьвер 0,3 с. Жесткая обработка.'},
    {title:'PD30II N',category:'Токарные станки',url:'equipment-turning-pd30ii-n.html',text:'Прутковый автомат PD30II с ЧПУ FANUC: шпиндель 6000 об/мин, 4,2 кВт, пруток до Ø30 мм, ход Z 270 мм, биение ≤0,002 мм. Точная обработка деталей.'},
    {title:'PM35 N',category:'Токарные станки',url:'equipment-turning-pm35-n.html',text:'Прутковый автомат PM35 с ЧПУ SYNTEC: шпиндель 5000 об/мин, сервопривод 3,7 кВт, пруток до Ø35 мм, биение ≤2 мкм. Точная обработка деталей.'},
    {title:'PM25 N',category:'Токарные станки',url:'equipment-turning-pm25-n.html',text:'Прутковый автомат PM25 с ЧПУ SYNTEC: шпиндель 5000 об/мин, сервопривод 3,7 кВт, пруток до Ø25 мм, биение ≤0,002 мм. Точная обработка деталей.'},
    {title:'PD20 N',category:'Токарные станки',url:'equipment-turning-pd20-n.html',text:'Прутковый автомат PD20 с ЧПУ FANUC: шпиндель 8000 об/мин, мощность 4,2 кВт, пруток до Ø20 мм, биение ≤0,002 мм. Точная обработка мелких деталей.'},
    {title:'YBK25II N',category:'Токарные станки',url:'equipment-turning-ybk25ii-n.html',text:'Прутковый автомат YBK25II с ЧПУ SYNTEC: шпиндель 3500 об/мин, 2,2 кВт, пруток до Ø25 мм, биение ≤0,002 мм. Обработка точных коротких деталей.'},
    {title:'SL-42-52-60-60L S',category:'Токарные станки',url:'equipment-turning-sl-42-52-60-60l-s.html',text:'Прутковый автомат SL-42/52/60/60L: шпиндель до 3500 об/мин, 7,5–15 кВт, пруток до Ø60 мм, наклонная станина 30°, револьвер до 12 позиций.'},
    {title:'PDJ30II N',category:'Токарные станки',url:'equipment-turning-pdj30ii-n.html',text:'Прутковый автомат PDJ30II с ЧПУ SYNTEC: шпиндель 6000 об/мин, 4,2 кВт, пруток до Ø30 мм, ход Z 270 мм, биение ≤0,002 мм. Точная обработка деталей.'},
    {title:'YBK35II N',category:'Токарные станки',url:'equipment-turning-ybk35ii-n.html',text:'Прутковый автомат YBK35II с ЧПУ SYNTEC: шпиндель 3500 об/мин, 3,0 кВт, пруток до Ø35 мм, биение ≤0,002 мм. Обработка точных коротких деталей.'},
    {title:'PDJ20 N',category:'Токарные станки',url:'equipment-turning-pdj20-n.html',text:'Прутковый автомат PDJ20 с ЧПУ SYNTEC: шпиндель 6000 об/мин, мощность 4,2 кВт, пруток до Ø20 мм, биение ≤0,002 мм. Обработка сложных точных деталей.'},
    {title:'PDJ30 N',category:'Токарные станки',url:'equipment-turning-pdj30-n.html',text:'Прутковый автомат PDJ30 с ЧПУ SYNTEC: шпиндель 6000 об/мин, мощность 4,2 кВт, пруток до Ø30 мм, биение ≤0,002 мм. Обработка сложных точных деталей.'},
    {title:'S266 N',category:'Токарные станки',url:'equipment-turning-s266-n.html',text:'S266 — швейцарский токарный автомат с контршпинделем: пруток Ø26 мм, 10000 об/мин, шпиндель 4.2 кВт, двухканальное ЧПУ SYNTEC. Обработка валов.'},
    {title:'SS-206E S',category:'Токарные станки',url:'equipment-turning-ss-206e-s.html',text:'Швейцарский токарный автомат SS-206E/266E/326E/386E: диаметр 20-38 мм, до 8000 об/мин, ЧПУ SYNTEC, 8 осей, две оси C. Купить в России.'},
    {title:'SS-32RB S',category:'Токарные станки',url:'equipment-turning-ss-32rb-s.html',text:'Швейцарский токарный автомат SS-32RB/42RB: диаметр до 42 мм, шпиндель до 7000 об/мин, ЧПУ Fanuc 32i, ось Y, два шпинделя. Купить в России.'},
    {title:'SS-12RB-RBY S',category:'Токарные станки',url:'equipment-turning-ss-12rb-rby-s.html',text:'SS-12RB/RBY — компактный швейцарский токарный автомат: пруток Ø12 мм, шпиндель 12000 об/мин, контршпиндель, ось Y. Прецизионные мелкие детали.'},
    {title:'SL265 N',category:'Токарные станки',url:'equipment-turning-sl265-n.html',text:'SL265 — швейцарский токарный автомат с контршпинделем: пруток Ø26 мм, 10000 об/мин, шпиндель 4.2 кВт, двухканальное ЧПУ. Прецизионные валы.'},
    {title:'SL125 N',category:'Токарные станки',url:'equipment-turning-sl125-n.html',text:'SL125 — швейцарский токарный автомат с контршпинделем: пруток Ø12 мм, шпиндель 12000 об/мин, ЧПУ SYNTEC двухканальное. Обработка мелких деталей.'},
    {title:'SL325 N',category:'Токарные станки',url:'equipment-turning-sl325-n.html',text:'SL325 — пятиосевой швейцарский токарный автомат: пруток Ø32 мм, шпиндель 6.3 кВт, контршпиндель, двухканальное ЧПУ SYNTEC. Обработка валов.'},
    {title:'SS-20A-20AS S',category:'Токарные станки',url:'equipment-turning-ss-20a-20as-s.html',text:'SS-20A/20AS — швейцарский токарный автомат: пруток Ø20 мм, шпиндель до 8000 об/мин, 3.7 кВт, ось Y. Полная обработка деталей за один установ.'},
    {title:'SL386 N',category:'Токарные станки',url:'equipment-turning-sl386-n.html',text:'SL386 — швейцарский токарный автомат: пруток Ø38 мм, шпиндель 6.3 кВт, контршпиндель, приводной инструмент, двухканальное ЧПУ SYNTEC. Обработка валов.'},
    {title:'S265 N',category:'Токарные станки',url:'equipment-turning-s265-n.html',text:'S265 — швейцарский токарный автомат с контршпинделем: пруток Ø26 мм, 10000 об/мин, шпиндель 4.2 кВт, двухканальное ЧПУ SYNTEC. Прецизионные валы.'},
    {title:'SL385 N',category:'Токарные станки',url:'equipment-turning-sl385-n.html',text:'SL385 — пятиосевой швейцарский токарный автомат: пруток Ø38 мм, шпиндель 6.3 кВт, контршпиндель, двухканальное ЧПУ SYNTEC. Обработка валов.'},
    {title:'SL203 N',category:'Токарные станки',url:'equipment-turning-sl203-n.html',text:'SL203 — швейцарский токарный автомат: пруток Ø20 мм, шпиндель 10000 об/мин, ЧПУ SYNTEC, мощность 4.2 кВт. Обработка сложных прецизионных деталей.'},
    {title:'CSL1203II N',category:'Токарные станки',url:'equipment-turning-csl1203ii-n.html',text:'CSL1203II — швейцарский токарный автомат: пруток Ø12 мм, шпиндель 8000 об/мин, ЧПУ SYNTEC, мощность 3.7 кВт. Точная обработка мелких деталей.'},
    {title:'SS-32A S',category:'Токарные станки',url:'equipment-turning-ss-32a-s.html',text:'SS-32A/32S/32AS/32AB/42AB — швейцарские токарные автоматы: пруток Ø26–42 мм, шпиндель 7.5 кВт, контршпиндель, ось Y, ЧПУ Fanuc. Точение деталей.'},
    {title:'SL326 N',category:'Токарные станки',url:'equipment-turning-sl326-n.html',text:'SL326 — шестиосевой швейцарский токарный автомат: пруток Ø32 мм, шпиндель 6.3 кВт, контршпиндель, двухканальное ЧПУ SYNTEC. Прецизионные валы.'},
    {title:'S205 N',category:'Токарные станки',url:'equipment-turning-s205-n.html',text:'S205 — швейцарский токарный автомат с контршпинделем: пруток Ø20 мм, 10000 об/мин, шпиндель 4.2 кВт, двухканальное ЧПУ SYNTEC. Прецизионные валы.'},
    {title:'SS-20-20A S',category:'Токарные станки',url:'equipment-turning-ss-20-20a-s.html',text:'SS-20/20A — швейцарский токарный автомат: пруток Ø20 мм, шпиндель до 8000 об/мин, 3.7 кВт, направляющая втулка. Прецизионные детали и имплантаты.'},
    {title:'SL263 N',category:'Токарные станки',url:'equipment-turning-sl263-n.html',text:'SL263 — швейцарский токарный автомат: пруток Ø26 мм, шпиндель 10000 об/мин, ЧПУ SYNTEC 8.4", мощность 4.2 кВт. Прецизионная обработка валов.'},
    {title:'SS-20AB-AST S',category:'Токарные станки',url:'equipment-turning-ss-20ab-ast-s.html',text:'SS-20AB/AST — швейцарский токарный автомат: пруток Ø20 мм, шпиндель до 8000 об/мин, 3.7 кВт, контршпиндель, 7 осей. Обработка прецизионных деталей.'},
    {title:'S206 N',category:'Токарные станки',url:'equipment-turning-s206-n.html',text:'S206 — швейцарский токарный автомат с контршпинделем: пруток Ø20 мм, 10000 об/мин, шпиндель 4.2 кВт, двухканальное ЧПУ SYNTEC. Обработка валов.'},
    {title:'SS-20RB-RBY S',category:'Токарные станки',url:'equipment-turning-ss-20rb-rby-s.html',text:'SS-20RB/RBY — швейцарский токарный автомат: пруток Ø20 мм, шпиндель 10000 об/мин, контршпиндель, ЧПУ Fanuc 32iB. Обработка прецизионных деталей.'},
    {title:'SS-205E S',category:'Токарные станки',url:'equipment-turning-ss-205e-s.html',text:'Швейцарский токарный автомат SS-205E/265E/325E/385E: диаметр 20-38 мм, до 8000 об/мин, ЧПУ SYNTEC, ось C, противошпиндель. Купить в России.'},
    {title:'SL205 N',category:'Токарные станки',url:'equipment-turning-sl205-n.html',text:'SL205 — швейцарский токарный автомат с контршпинделем: пруток Ø20 мм, 10000 об/мин, шпиндель 4.2 кВт, двухканальное ЧПУ. Обработка тонких валов.'},
    {title:'VT400 Z',category:'Токарные станки',url:'equipment-turning-vt400-z.html',text:'Вертикальный токарный станок с ЧПУ VT400: макс. диаметр точения Ø450 мм, высота 420 мм, шпиндель до 2500 об/мин, мощность до 37 кВт, 8-позиционная револьверная головка.'},
    {title:'CK514 B',category:'Токарные станки',url:'equipment-turning-ck514-b.html',text:'Вертикальный токарный станок с ЧПУ CK514: макс. диаметр Ø650 мм, шпиндель 30–3000 об/мин, мощность 18,5/22 кВт, 6-позиционная револьверная головка. Купить в России.'},
    {title:'VT600 Z',category:'Токарные станки',url:'equipment-turning-vt600-z.html',text:'Вертикальный токарный станок с ЧПУ VT600: макс. диаметр точения Ø600 мм, высота 600 мм, шпиндель до 1500 об/мин, мощность до 45 кВт, 8-позиционная револьверная головка.'},
    {title:'KDVL600 K',category:'Токарные станки',url:'equipment-turning-kdvl600-k.html',text:'Вертикальный токарный станок с ЧПУ KDVL600: макс. диаметр точения Ø600 мм, высота 600 мм, шпиндель 100–2000 об/мин, мощность 18,5/22 кВт, 8-позиционная головка.'},
    {title:'KDVL700 K',category:'Токарные станки',url:'equipment-turning-kdvl700-k.html',text:'Вертикальный токарный станок с ЧПУ KDVL700: диаметр точения Ø700 мм, высота 700 мм, шпиндель 50–1700 об/мин, мощность 37 кВт, стол до 1200 кг, точность 0,004 мм.'},
    {title:'KDVL500 K',category:'Токарные станки',url:'equipment-turning-kdvl500-k.html',text:'Вертикальный токарный станок с ЧПУ KDVL500: диаметр точения до Ø530 мм, высота 500 мм, шпиндель 100–2500 об/мин, мощность 22 кВт, 8-позиционная головка, точность 0,006 мм.'},
    {title:'KDVL1100B K',category:'Токарные станки',url:'equipment-turning-kdvl1100b-k.html',text:'Вертикальный токарный станок с ЧПУ KDVL1100B: диаметр точения Ø1100 мм, высота 1000 мм, шпиндель 15–600 об/мин, мощность 30 кВт, стол до 4000 кг, точность до 0,007 мм.'},
    {title:'KDVL320 K',category:'Токарные станки',url:'equipment-turning-kdvl320-k.html',text:'Вертикальный токарный станок с ЧПУ KDVL320: макс. диаметр точения Ø320 мм, высота 420 мм, шпиндель 100–2800 об/мин, мощность 7,5/11 кВт, 8-позиционная головка.'},
    {title:'VT320 Z',category:'Токарные станки',url:'equipment-turning-vt320-z.html',text:'Вертикальный токарный станок с ЧПУ VT320: макс. диаметр точения Ø350 мм, высота 400 мм, шпиндель до 3000 об/мин, мощность 22 кВт, 8-позиционная револьверная головка.'},
    {title:'KDVL460 K',category:'Токарные станки',url:'equipment-turning-kdvl460-k.html',text:'Вертикальный токарный станок с ЧПУ KDVL460: макс. диаметр точения Ø460 мм, высота 430 мм, шпиндель 100–2000 об/мин, мощность 15/18,5 кВт, 8-позиционная головка.'},
    {title:'CK516 B',category:'Токарные станки',url:'equipment-turning-ck516-b.html',text:'Вертикальный токарный станок с ЧПУ CK516: макс. диаметр Ø850 мм, шпиндель 10–1600 об/мин, мощность 22/26 кВт, момент 1192 Н·м, 6-позиционная головка. Купить в России.'},
    {title:'C5112 Ft',category:'Токарные станки',url:'equipment-turning-c5112-ft.html',text:'Одностоечный токарно-карусельный станок C5112 Ft (серия C5112–C5126): макс. диаметр обточки до 2600 мм, стол до 2250 мм, масса заготовки до 10 т, УЦИ по 2 осям.'},
    {title:'C5225 Ft',category:'Токарные станки',url:'equipment-turning-c5225-ft.html',text:'Двухстоечный токарно-карусельный станок C5225 Ft (серия C5225–C5263): диаметр обточки до 6300 мм, стол до 5700 мм, масса заготовки до 100 т, ход траверсы до 3500 мм.'},
    {title:'CK5112HM Ft',category:'Токарные станки',url:'equipment-turning-ck5112hm-ft.html',text:'Одностоечный токарно-фрезерный карусельный центр CK5112HM Ft: диаметр обточки до 2300 мм, стол до 2000 мм, приводной шпиндель ISO50/BT50, ATC 24+6, момент 600 Н·м.'},
    {title:'CK5228M Ft',category:'Токарные станки',url:'equipment-turning-ck5228m-ft.html',text:'Двухстоечный токарно-фрезерный карусельный центр CK5228M Ft: диаметр обработки до 10000 мм, стол до 7200 мм, масса до 200 т, приводной шпиндель ISO50/BT50, ЧПУ Siemens/Fanuc.'},
    {title:'CK5112 Ft',category:'Токарные станки',url:'equipment-turning-ck5112-ft.html',text:'Одностоечный токарно-карусельный станок с ЧПУ CK5112 Ft (серия CK5112–CK5126): диаметр обработки до 2600 мм, стол до 2250 мм, масса до 10 т, ЧПУ Siemens/Fanuc.'},
    {title:'CK5225 Ft',category:'Токарные станки',url:'equipment-turning-ck5225-ft.html',text:'Двухстоечный токарно-карусельный станок с ЧПУ CK5225 Ft (серия CK5225–CK52100): диаметр обработки до 10000 мм, стол до 7200 мм, масса до 200 т, ЧПУ Siemens/Fanuc.'}
  ];
  function normalizeSearch(v){return String(v||'').toLowerCase().replace(/ё/g,'е')}
  function compactSearch(v){return normalizeSearch(v).replace(/[^a-zа-я0-9]+/g,'')}
  function escapeSearchHtml(v){
    return String(v||'').replace(/[&<>"']/g,function(ch){
      return {'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[ch];
    });
  }
  var SEARCH_INDEX_ITEMS=null;
  ...
  function loadSearchIndex(){
    ...
    SEARCH_INDEX_PROMISE=window.fetch('search-index.json',{cache:'no-cache'})
  ...
  function scoreSearchItem(item,q,tokens){
    ...
    var category=normalizeSearch(item.category);
    var text=normalizeSearch(item.text);
    var keywords=normalizeSearch(item.keywords);
    var url=normalizeSearch(item.url);
    var haystack=title+' '+category+' '+text+' '+keywords+' '+url;
    var compactQ=compactSearch(q);
    var score=0;
    var missed=0;
    if(title===q)score+=220;
    if(title.indexOf(q)===0)score+=120;
    if(haystack.indexOf(q)>-1)score+=30;
    if(compactQ&&compactSearch(title).indexOf(compactQ)>-1)score+=90;
    if(compactQ&&compactSearch(url).indexOf(compactQ)>-1)score+=45;
    tokens.forEach(function(token){
      if(!token)return;
      if(title.indexOf(token)>-1){score+=70;return}
      if(category.indexOf(token)>-1){score+=35;return}
      if(keywords.indexOf(token)>-1){score+=28;return}
      if(text.indexOf(token)>-1){score+=18;return}
      if(url.indexOf(token)>-1){score+=14;return}
      missed+=1;
    });
    if(missed&&(!compactQ||compactSearch(haystack).indexOf(compactQ)<0))return 0;
    if(/^stock/.test(item.url||''))score+=4;
    if(/^equipment/.test(item.url||''))score+=3;
    return score;
  }
  function searchSiteItems(query,limit){
    var q=normalizeSearch(query).trim();
    var items=allSearchItems();
    var max=limit||10;
    if(!q)return items.slice(0,max);
    var tokens=q.split(/[^a-zа-я0-9]+/).filter(function(token){return token.length>1});
    if(!tokens.length)tokens=[q];
    return items.map(function(item){
      return {item:item,score:scoreSearchItem(item,q,tokens)};
    }).filter(function(entry){
      return entry.score>0;
    }).sort(function(a,b){
      if(b.score!==a.score)return b.score-a.score;
      return String(a.item.title).localeCompare(String(b.item.title),'ru');
    }).slice(0,max).map(function(entry){return entry.item});
  }
  window.MEHANIT_SEARCH={
    load:loadSearchIndex,
    search:searchSiteItems,
    items:allSearchItems
  };
  if(window.requestIdleCallback){
    window.requestIdleCallback(function(){loadSearchIndex()},{timeout:3000});
  }else{
    window.setTimeout(function(){loadSearchIndex()},1600);
  }
  ...
  function initHeaderWidgets(){
    ...
    function renderSearch(query){
      ...
      searchResults.innerHTML=items.map(function(item,i){
        return '<a class="hsp-item" href="'+escapeSearchHtml(item.url)+'" data-index="'+i+'" data-url="'+escapeSearchHtml(item.url)+'" data-type="'+escapeSearchHtml(item.category)+'"><small>'+escapeSearchHtml(item.category)+'</small><b>'+escapeSearchHtml(item.title)+'</b><span>'+escapeSearchHtml(item.text)+'</span></a>';
      }).join('')+'<div class="hsp-all" aria-hidden="true">Показаны наиболее релевантные страницы</div>';
      searchResults.classList.add('is-visible');
    ...
    function openSearch(){
      ...
      loadSearchIndex().then(function(){if(searchOpen){renderSearch(searchInput.value)}});
    }
    ...
    /* ===== Глобальная модалка «Обсудить задачу с технологом» ===== */
    var taskModal=document.createElement('div');
    taskModal.className='header-modal';
    taskModal.id='mhTaskModal';
    ...
    function onTaskKeydown(e){
      if(e.key==='Escape'){closeTaskModal(true);return}
      if(e.key==='Tab'){
        var f=taskModal.querySelectorAll('a,button,input,textarea');
        if(!f.length)return;
        var first=f[0],last=f[f.length-1];
        if(e.shiftKey&&document.activeElement===first){e.preventDefault();last.focus()}
        else if(!e.shiftKey&&document.activeElement===last){e.preventDefault();first.focus()}
    ...
    function openTaskModal(src){
      ...
      document.body.style.overflow='hidden';
      trackEvent('task_modal_open',{page_path:location.pathname,device_type:deviceType(),source:src||'button'});
      window.setTimeout(function(){taskModal.querySelector('#mhTaskName').focus()},80);
      document.addEventListener('keydown',onTaskKeydown);
    }
    function closeTaskModal(returnFocus){
      if(!tmOpen)return;
      tmOpen=false;
      ...
      if(returnFocus&&tmReturn&&tmReturn.focus)tmReturn.focus();
    }
    taskModal.querySelector('#mhTaskClose').addEventListener('click',function(){closeTaskModal(true)});
    taskModal.addEventListener('click',function(e){if(e.target===taskModal){closeTaskModal(false)}});
    taskModal.querySelector('#mhTaskForm').addEventListener('submit',function(e){
      e.preventDefault();
      var phone=taskModal.querySelector('#mhTaskPhone');
      var consent=taskModal.querySelector('#mhTaskConsent');
      var phoneErr=taskModal.querySelector('#mhTaskPhoneErr');
      var consentErr=taskModal.querySelector('#mhTaskConsentErr');
      var status=taskModal.querySelector('#mhTaskStatus');
      phoneErr.textContent='';consentErr.textContent='';
      var ok=true;
    ...
    if(taskBtn){taskBtn.addEventListener('click',function(){
      if(typeof window.openLeadModal==='function'){window.openLeadModal('task')}else{openTaskModal('header')}
    })}
    window.openCallback=openCallback;
    callbackBtn.addEventListener('click',openCallback);
    var hcpCb=contactsPanel.querySelector('#hcpCallbackBtn');
    if(hcpCb){hcpCb.addEventListener('click',function(){reallyCloseContacts(false);openCallback()})}
    ...
    cbForm.addEventListener('submit',function(e){
      ...
      window.setTimeout(function(){
        ...
        status.textContent='Заявка принята. Ответим в течение рабочего дня.';
        cbForm.reset();
      },600);
    });
...
/* ---- Ориентир в рублях для цен в юанях: курс ЦБ РФ (зеркало cbr-xml-daily.ru), кэш 6 часов ---- */
(function(){
  function run(){
    var re=/^\s*[\d\s  ]+\s*¥\s*$/;
    var els=[].slice.call(document.querySelectorAll('b,strong,.price-amount')).filter(function(el){return re.test(el.textContent)});
    if(!els.length)return;
    function apply(rate,date){
      els.forEach(function(el){
        var anchor=el.classList.contains('price-amount')?el:el.parentNode;
        if(anchor.nextElementSibling&&anchor.nextElementSibling.classList.contains('rub-approx'))return;
        var cny=parseInt(el.textContent.replace(/[^\d]/g,''),10);if(!cny)return;
        var rub=Math.round(cny*rate/1000)*1000;
        var span=document.createElement('div');span.className='rub-approx';
        span.textContent='≈ '+rub.toLocaleString('ru-RU')+' ₽ по курсу ЦБ на '+date;
        anchor.insertAdjacentElement('afterend',span);
      });
    }
    var key='mh_cny_rate_v1',cached=null;
    try{cached=JSON.parse(localStorage.getItem(key)||'null')}catch(e){}
    if(cached&&Date.now()-cached.t<6*3600*1000){apply(cached.r,cached.d);return}
    fetch('https://www.cbr-xml-daily.ru/daily_json.js').then(function(r){return r.json()}).then(function(j){
      var v=j&&j.Valute&&j.Valute.CNY;if(!v)return;
      var rate=v.Value/v.Nominal,d=new Date(j.Date);
      var date=('0'+d.getDate()).slice(-2)+'.'+('0'+(d.getMonth()+1)).slice(-2)+'.'+d.getFullYear();
      try{localStorage.setItem(key,JSON.stringify({r:rate,d:date,t:Date.now()}))}catch(e){}
      apply(rate,date);
    }).catch(function(){});
  }
  if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',run)}else{run()}

  /* Мобильная главная: свернуть длинные каталожные сетки до четырёх позиций */
  function mhCollapseGrids(){
    [['.eq-grid-static','Показать все станки'],['.sol-list','Показать все отрасли']].forEach(function(pair){
      var grid=document.querySelector(pair[0]);
      if(!grid||grid.dataset.mhMore==='1')return;
      var items=grid.children.length;
      if(items<=4)return;
      grid.dataset.mhMore='1';
      var btn=document.createElement('button');
      btn.type='button';
      btn.className='btn btn-ghost mh-more';
      btn.textContent=pair[1]+' ('+items+')';
      btn.addEventListener('click',function(){
        var open=grid.classList.toggle('is-expanded');
        btn.textContent=open?'Свернуть':(pair[1]+' ('+items+')');
      });
      grid.parentNode.insertBefore(btn,grid.nextSibling);
    });
  }
  if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',mhCollapseGrids);}
  else{mhCollapseGrids();}
...
(function(){
  function initMobileCatalogFilters(){
    ...
    function dataKey(name){return name.replace(/-([a-z])/g,function(m,c){return c.toUpperCase();});}
    function inRange(value,min,max){
      if(!min&&!max)return true;
      if(!value)return false;
      var minNum=min?num(min):null,maxNum=max?num(max):null;
      return String(value).split('|').some(function(tok){
        var p=tok.split('~'),lo=num(p[0]),hi=p.length>1?num(p[1]):lo;
        if(lo===null)return false;
        if(hi===null)hi=lo;
        if(minNum!==null&&hi<minNum)return false;
        if(maxNum!==null&&lo>maxNum)return false;
        return true;
      });
    }
    document.querySelectorAll('[data-vmc-scope]').forEach(function(scope){
      if(scope.dataset.mobileFilterReady==='1')return;
      var panel=scope.querySelector('.vmc-filter-panel');
      var grid=scope.querySelector('.vmc-grid');
      if(!panel||!grid)return;
      var cards=Array.prototype.slice.call(grid.querySelectorAll('.vmc-card'));
      var search=panel.querySelector('[data-role="search"]');
      var preview=panel.querySelector('[data-role="preview"]');
      var rangeNames=[];
      Array.prototype.slice.call(panel.querySelectorAll('[data-range]')).forEach(function(input){
        var name=input.getAttribute('data-range');
        if(rangeNames.indexOf(name)<0)rangeNames.push(name);
      });
      var checkGroups=[];
      Array.prototype.slice.call(panel.querySelectorAll('input[type="checkbox"][name]')).forEach(function(input){
        var name=input.getAttribute('name');
        if(checkGroups.indexOf(name)<0)checkGroups.push(name);
      });
      function rangeVals(name){
        var minEl=panel.querySelector('[data-range="'+name+'"][data-bound="min"]');
        var maxEl=panel.querySelector('[data-range="'+name+'"][data-bound="max"]');
        return [minEl&&minEl.value,maxEl&&maxEl.value];
      }
      function checkedValues(name){
        return Array.prototype.slice.call(panel.querySelectorAll('input[name="'+name+'"]:checked')).map(function(input){return input.value;});
      }
      function matches(){
        var q=(search&&search.value||'').trim().toLowerCase();
        return cards.filter(function(card){
          if(q&&(card.dataset.name||'').indexOf(q)<0)return false;
          for(var i=0;i<checkGroups.length;i++){
            var selected=checkedValues(checkGroups[i]);
            if(selected.length){
              var val=card.dataset[dataKey(checkGroups[i])]||'';
              var vals=val.split('|');
              if(!selected.some(function(s){return vals.indexOf(s)>=0;}))return false;
            }
          }
          for(var j=0;j<rangeNames.length;j++){
            var mm=rangeVals(rangeNames[j]);
            if(!inRange(card.dataset[dataKey(rangeNames[j])],mm[0],mm[1]))return false;
          }
          return true;
        });
      }
      function renderIfMobile(){
        if(!mq.matches)return;
        var m=matches();
        if(preview)preview.textContent=m.length;
        cards.forEach(function(card){card.classList.toggle('is-hidden',m.indexOf(card)<0);});
      }
      panel.querySelectorAll('input').forEach(function(input){
        input.addEventListener('input',renderIfMobile);
        input.addEventListener('change',renderIfMobile);
      });
      var toggle=scope.querySelector('[data-role="filter-toggle"]');
      if(toggle){
        toggle.addEventListener('click',function(){
          document.querySelectorAll('.vmc-filter-panel.is-open').forEach(function(openPanel){
            if(openPanel!==panel)openPanel.classList.remove('is-open');
          });
          document.querySelectorAll('.eqcat-filter-backdrop.is-open').forEach(function(backdrop){
            if(!scope.contains(backdrop))backdrop.classList.remove('is-open');
          });
        });
      }
      scope.dataset.mobileFilterReady='1';
    });
  }
